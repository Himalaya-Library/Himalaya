...
public:
   ...
   void set_correction(mh2_eft::EFTCouplingOrders::EFTCouplingOrders, int);
...
private:
   ...
   std::array<int,mh2_eft::EFTCouplingOrders::EFTCouplingOrders::NUMBER_OF_EFT_ORDERS> orders{};   ///< enable/disable corrections
