...
namespace ThresholdVariables {
   ...
   enum ThresholdVariables : int{
      ...
      VEV_YB2            = 35,      ///< Flag for vev_yb2 threshold correction
      VEV_YTAU2          = 36,      ///< Flag for vev_ytau2 threshold correction
      VEV_G12            = 37,      ///< Flag for ytau_yb threshold correction
      VEV_G22            = 38,      ///< Flag for ytau_yb threshold correction
      YTAU_YB            = 39,      ///< Flag for ytau_yb threshold correction
      LAMBDA_YTAU4_YB2   = 40,      ///< Flag for ytau4_yb2 threshold correction
      LAMBDA_YTAU2_YB4   = 41,      ///< Flag for ytau2_yb4 threshold correction
      YB_YT              = 42,
      YB_AS              = 43,
      YB_YB              = 44,
