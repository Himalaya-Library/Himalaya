 ...
 */
double himalaya::H6b::calc_at_as2_no_logs(){
   ...
   const double result =
      (-(pow2(Sbeta)*(80015040000*pow2(Mst2)*pow2(Mt)*pow3(Dmsqst2) + (30*
        ...
        z3 + 48*z4 + 72*pow2(z2)) + 3456*Mst2*s2t*(15 - 20*z2 + 16*z3)*pow3(Mt)
        + 6912*Mt*(3 - 3*z2 + z3)*pow3(Mst2)*pow3(s2t) + 16*(-6190 + 5616*z2 -
        2025*z3)*pow4(Mt) - (2122 + 128*OepS2 - 55728*S2 - 192*T1ep - 4152*z2 +
        13209*z3 - 96*z4 - 144*pow2(z2))*pow4(Mst2)*pow4(s2t)) - 2058*pow4(
        Mst1)*(4*pow2(Mst2)*pow2(Mt)*pow2(s2t)*(487028 + 40000*OepS2 - 1917000*
        S2 - 60000*T1ep - 1081500*z2 - 2625*z3 - 30000*z4 - 45000*pow2(z2)) +
        ...
        710625*z3 + 48000*z4 + 72000*pow2(z2))*pow4(Mst2)*pow4(s2t)) + 5*pow2(
        s2t)*(33339600*Mst2*Mt*s2t*(69 - 90*z2 + 60*z3) + pow2(Mst2)*pow2(s2t)*
        (76781738 + 15366400*OepS2 - 837194400*S2 - 23049600*T1ep - 207652200*
        z2 - 63103425*z3 - 11524800*z4 - 17287200*pow2(z2)) + 600*pow2(Mt)*(-
        109760*OepS2 + 3*(1281429 + 1720488*S2 + 54880*T1ep + 44590*z2 -
        303212*z3 + 27440*z4 + 41160*pow2(z2))))*pow6(Mst1)) - 4*(-385875*pow2(
        Mst1)*pow3(Mst2)*(16*Dmglst2*(36*(23 - 24*z2)*pow2(Mst2)*pow2(Mt)*pow2(
        s2t) + 24*Mst2*s2t*(289 - 342*z2 + 216*z3)*pow3(Mt) + 216*Mt*(2 - 2*z2
        + z3)*pow3(Mst2)*pow3(s2t) + 8*(-1477 + 1242*z2 - 540*z3)*pow4(Mt) +
        27*(-2 + 4*z2 - 3*z3)*pow4(Mst2)*pow4(s2t)) + 3*Mst2*(-4*pow2(Mst2)*
        ...
        276*z3 + 24*z4 + 36*pow2(z2))*pow4(Mst2)*pow4(s2t))) - 3087*Mst2*pow4(
        Mst1)*(4500*Dmglst2*(8*(113 - 48*z2)*pow2(Mst2)*pow2(Mt)*pow2(s2t) +
        192*Mst2*s2t*(-51*z2 + 28*(2 + z3))*pow3(Mt) + 96*Mt*(5*z2 + 3*(-4 +
        z3))*pow3(Mst2)*pow3(s2t) + 48*(-401 + 308*z2 - 144*z3)*pow4(Mt) - 3*(-
        75 + 32*z2 + 8*z3)*pow4(Mst2)*pow4(s2t)) + Mst2*(8*pow2(Mst2)*pow2(Mt)*
        ...
        pow2(z2))*pow4(Mst2)*pow4(s2t))) + 41674500*(Mst2 - 4*Dmglst2*(-3 + z2)
        + 2*Mst2*z2)*pow2(-4*pow2(Mt) + pow2(Mst2)*pow2(s2t))*pow5(Mst2) + 2*(
        4*Mst2*pow2(Mt)*pow2(s2t)*(-1157625*Dmglst2*(-1931 + 1098*z2 + 180*z3)
        + Mst2*(22430251 - 5488000*OepS2 + 324135000*S2 + 8232000*T1ep +
        103929000*z2 - 28812000*z3 + 4116000*z4 + 6174000*pow2(z2))) -
        333396000*s2t*(Mst2*(-35 + 20*z2 - 16*z3) + Dmglst2*(465 - 348*z2 +
        176*z3))*pow3(Mt) + 333396000*Mt*(Dmglst2*(20 - 11*z2) + Mst2*(-2 + z2)
        )*pow2(Mst2)*pow3(s2t) + 3456*(-6582784 + 2701125*z2 - 2315250*z3)*
        pow4(Mt) + (4630500*Dmglst2*(38 + 63*z2 - 90*z3) + Mst2*(378483467 +
        9604000*OepS2 - 754771500*S2 - 14406000*T1ep - 306899250*z2 +
        133770000*z3 - 7203000*z4 - 10804500*pow2(z2)))*pow3(Mst2)*pow4(s2t))*
        pow6(Mst1))))/pow2(Mst1) - (Mst2*(-4*Dmglst2*(-66150*pow4(Mst1)*pow4(
        Mst2)*(-672*(-11674 + 120*B4 - 120*D3 + 60*DN + 17091*S2 + 4849*z2 +
        2195*z3 - 540*z4)*pow2(Mst2)*pow2(Mt)*pow2(s2t) + 140*Mst2*s2t*(-1120*
        OepS2 + 3*(10061 - 14580*S2 + 560*T1ep + 25134*z2 - 72*z3 - 2024*z4 +
        420*pow2(z2)))*pow3(Mt) + 7*Mt*(69997 + 188640*B4 - 3600*DN + 5600*
        ...
        pow4(Mst2)*pow4(s2t)) + 1764*pow2(Mst2)*(-112*pow2(Mst2)*pow2(Mt)*pow2(
        s2t)*(1216808 + 150000*OepS2 - 376650*S2 - 225000*T1ep - 3408750*z2 -
        ...
        5325300*z2 - 4227750*z3 + 121500*z4)*pow4(Mst2)*pow4(s2t))*pow6(Mst1) +
        333396000*(2*Mt + Mst2*s2t)*(14*Mt*(3 + z2) + Mst2*s2t*(5 + 7*z2))*
        pow2(Mst1)*pow2(-2*Mt + Mst2*s2t)*pow6(Mst2) - (-72*pow2(Mst2)*pow2(Mt)
        *pow2(s2t)*(3650009897 - 2110136000*OepS2 + 52385772600*S2 +
        ...
        z2))*pow4(Mst2)*pow4(s2t))*pow8(Mst1)) + 3*Mst2*(-308700*pow4(Mst1)*
        pow4(Mst2)*(-2*pow2(Mst2)*pow2(Mt)*pow2(s2t)*(1013263 + 2880*D3 - 2880*
        DN - 25440*OepS2 - 137052*S2 + 38160*T1ep + 35562*z2 + 83160*z3 +
        36360*z4 + 28620*pow2(z2)) + 24*Mst2*s2t*(60759 - 1120*OepS2 - 25596*S2
        + 1680*T1ep + 137386*z2 - 115320*z3 + 12360*z4 + 1260*pow2(z2))*pow3(
        Mt) - 30*Mt*(25611 + 5280*B4 - 48*DN - 224*OepS2 - 324*S2 + 336*T1ep -
        13614*z2 + 47720*z3 + 2040*z4 - 6660*pow2(z2))*pow3(Mst2)*pow3(s2t) -
        8*(389597 + 3360*OepS2 - 105948*S2 - 5040*T1ep + 293898*z2 - 740160*z3
        - 2520*z4 - 3780*pow2(z2))*pow4(Mt) + 5*(25289 - 144*D3 + 72*DN - 2208*
        OepS2 + 298404*S2 + 3312*T1ep + 36318*z2 - 94968*z3 + 1440*(B4 + z4) -
        108*pow2(z2))*pow4(Mst2)*pow4(s2t)) - 20580*pow2(Mst2)*(-4*pow2(Mst2)*
        pow2(Mt)*pow2(s2t)*(2367149 - 21600*D3 + 21600*DN - 503200*OepS2 +
        14889420*S2 + 754800*T1ep + 9292470*z2 - 66000*z3 + 247800*z4 + 566100*
        pow2(z2)) + 40*Mst2*s2t*(1156193 - 60320*OepS2 + 1414908*S2 + 90480*
        T1ep + 2823942*z2 - 2907240*z3 + 45240*z4 + 67860*pow2(z2))*pow3(Mt) -
        100*Mt*(51041 + 7344*B4 + 216*DN - 2336*OepS2 + 112428*S2 + 3504*T1ep +
        28038*z2 - 78216*z3 + 8880*z4 + 2628*pow2(z2))*pow3(Mst2)*pow3(s2t) -
        8*(7319011 + 167200*OepS2 - 6744060*S2 - 250800*T1ep + 9301170*z2 -
        ...
        pow4(s2t))*pow6(Mst1) - 55566000*pow2(Mst1)*(8*(87 + 38*z2)*pow2(Mst2)*
        pow2(Mt)*pow2(s2t) + 1024*Mst2*s2t*pow3(Mt) - 256*Mt*pow3(Mst2)*pow3(
        s2t) - 16*(71 + 38*z2)*pow4(Mt) - (135 + 38*z2)*pow4(Mst2)*pow4(s2t))*
        pow6(Mst2) + 196*pow2(Dmglst2)*(1134000*pow2(Mst1)*pow4(Mst2)*(8*(179 -
        ...
        + 16*(46632377 - 744800*OepS2 - 29679210*S2 + 1117200*T1ep + 107181930*
        z2 - 108350025*z3 + 558600*z4 + 837900*pow2(z2))*pow4(Mt) + 35*(924689
        - 41040*B4 + 43200*D3 - 22680*DN + 1120*OepS2 - 21325356*S2 - 1680*T1ep
        + 127686*z2 + 3687510*z3 + 190320*z4 + 37620*pow2(z2))*pow4(Mst2)*pow4(
        s2t)) - 2*(-36*pow2(Mst2)*pow2(Mt)*pow2(s2t)*(68526791 + 2772000*OepS2
        - 107403300*S2 - 4158000*T1ep - 140027250*z2 + 39514125*z3 - 2079000*z4
        - 3118500*pow2(z2)) - 800*Mst2*s2t*(7384247 + 1183840*OepS2 + 5821092*
        S2 - 1775760*T1ep - 59988552*z2 + 25757760*z3 - 887880*z4 - 1331820*
        pow2(z2))*pow3(Mt) - 350*Mt*(2727217 - 437920*OepS2 + 3648132*S2 +
        656880*T1ep + 12301638*z2 - 4166400*z3 + 328440*z4 + 492660*pow2(z2))*
        pow3(Mst2)*pow3(s2t) + 8*(648916519 + 158732000*OepS2 + 66753450*S2 -
        238098000*T1ep - 10760276550*z2 + 6504855000*z3 - 119049000*z4 -
        178573500*pow2(z2))*pow4(Mt) + 7*(21452821 - 243000*B4 + 324000*D3 -
        202500*DN - 2272000*OepS2 + 75724200*S2 + 3408000*T1ep + 55081500*z2 -
        67149750*z3 + 3040500*z4 + 4014000*pow2(z2))*pow4(Mst2)*pow4(s2t))*
        pow6(Mst1) + 18144000*pow2(-4*pow2(Mt) + pow2(Mst2)*pow2(s2t))*pow6(
        Mst2)) + (-1097600*Mst2*s2t*(2016907 - 109600*OepS2 + 3520152*S2 +
        164400*T1ep + 3448554*z2 - 3465480*z3 + 82200*z4 + 123300*pow2(z2))*
        pow3(Mt) + 68600*Mt*(2759935 - 70240*OepS2 + 3305340*S2 + 105360*T1ep +
        629034*z2 - 2677800*z3 + 52680*z4 + 79020*pow2(z2))*pow3(Mst2)*pow3(
        s2t) + 16*(pow2(Mst2)*pow2(Mt)*pow2(s2t)*(25002374272 - 4703902000*
        OepS2 + 184815757350*S2 + 7055853000*T1ep + 84661721025*z2 -
        16805113500*z3 + 3527926500*z4 + 5291889750*pow2(z2)) + (187545955063 +
        3204992000*OepS2 - 128216692800*S2 - 4807488000*T1ep + 129009640200*z2
        - 399103824000*z3 - 2403744000*z4 - 3605616000*pow2(z2))*pow4(Mt)) + (
        93508520089 + 2000376000*B4 + 222264000*D3 - 222264000*DN + 4925480000*
        OepS2 - 312095700000*S2 - 7388220000*T1ep - 77106571500*z2 +
        21506100000*z3 - 2360526000*z4 - 5541165000*pow2(z2))*pow4(Mst2)*pow4(
        s2t))*pow8(Mst1) + 7112448000*pow2(Mt)*(-2*pow2(Mt) + pow2(Mst2)*pow2(
        s2t))*pow8(Mst2))))/pow4(Mst1)))/(6.001128e9*pow6(Mst2)))/pow4(Mt)/
        pow2(Sbeta)*12.;
