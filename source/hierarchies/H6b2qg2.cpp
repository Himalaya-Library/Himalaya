 ...
 */
double himalaya::H6b2qg2::calc_at_as2_no_logs(){

   const double result =
      ((pow2(Sbeta)*(-80015040000*pow2(Mst2)*pow2(Mt)*pow3(Dmsqst2) + (30*pow2(
        Dmsqst2)*(166698000*(-2 + z2)*pow2(-4*pow2(Mt) + pow2(Mst2)*pow2(s2t))*
        pow4(Mst2) - 385875*pow2(Mst1)*pow2(Mst2)*(-8*pow2(Mst2)*pow2(Mt)*pow2(
        s2t)*(-160 + 64*OepS2 - 648*S2 - 96*T1ep - 2076*z2 + 903*z3 - 48*z4 -
        72*pow2(z2)) + 3456*Mst2*s2t*(-15 + 20*z2 - 16*z3)*pow3(Mt) + 6912*Mt*(
        -3 + 3*z2 - z3)*pow3(Mst2)*pow3(s2t) + (99040 - 89856*z2 + 32400*z3)*
        pow4(Mt) + (2122 + 128*OepS2 - 55728*S2 - 192*T1ep - 4152*z2 + 13209*z3
        - 96*z4 - 144*pow2(z2))*pow4(Mst2)*pow4(s2t)) + 2058*pow4(Mst1)*(4*
        ...
        s2t)*(-100018800*Mst2*Mt*s2t*(-23 + 30*z2 - 20*z3) + pow2(Mst2)*pow2(
        s2t)*(76781738 + 15366400*OepS2 - 837194400*S2 - 23049600*T1ep -
        207652200*z2 - 63103425*z3 - 11524800*z4 - 17287200*pow2(z2)) - 600*
        pow2(Mt)*(109760*OepS2 - 3*(1281429 + 1720488*S2 + 54880*T1ep + 44590*
        z2 - 303212*z3 + 27440*z4 + 41160*pow2(z2))))*pow6(Mst1)))/pow2(Mst1) +
        (120*Dmsqst2*(-1543500*Dmglst2*Mgl*Mst2*(4*pow2(Mst1)*pow3(Mst2)*(36*(
        23 - 24*z2)*pow2(Mst2)*pow2(Mt)*pow2(s2t) + 24*Mst2*s2t*(289 - 342*z2 +
        216*z3)*pow3(Mt) - 216*Mt*(-2 + 2*z2 - z3)*pow3(Mst2)*pow3(s2t) + 8*(-
        1477 + 1242*z2 - 540*z3)*pow4(Mt) + 27*(-2 + 4*z2 - 3*z3)*pow4(Mst2)*
        pow4(s2t)) - 9*Mst2*pow4(Mst1)*(8*(-113 + 48*z2)*pow2(Mst2)*pow2(Mt)*
        pow2(s2t) + 192*Mst2*s2t*(51*z2 - 28*(2 + z3))*pow3(Mt) - 96*Mt*(5*z2 +
        3*(-4 + z3))*pow3(Mst2)*pow3(s2t) - 48*(-401 + 308*z2 - 144*z3)*pow4(
        Mt) + 3*(-75 + 32*z2 + 8*z3)*pow4(Mst2)*pow4(s2t)) + 108*(-3 + z2)*
        ...
        *pow3(Mst2)*pow3(s2t))*pow6(Mst1)) - 1543500*Mst2*pow2(Dmglst2)*(4*
        pow2(Mst1)*pow3(Mst2)*(36*(23 - 24*z2)*pow2(Mst2)*pow2(Mt)*pow2(s2t) +
        24*Mst2*s2t*(289 - 342*z2 + 216*z3)*pow3(Mt) - 216*Mt*(-2 + 2*z2 - z3)*
        pow3(Mst2)*pow3(s2t) + 8*(-1477 + 1242*z2 - 540*z3)*pow4(Mt) + 27*(-2 +
        4*z2 - 3*z3)*pow4(Mst2)*pow4(s2t)) - 9*Mst2*pow4(Mst1)*(8*(-113 + 48*
        z2)*pow2(Mst2)*pow2(Mt)*pow2(s2t) + 192*Mst2*s2t*(51*z2 - 28*(2 + z3))*
        pow3(Mt) - 96*Mt*(5*z2 + 3*(-4 + z3))*pow3(Mst2)*pow3(s2t) - 48*(-401 +
        308*z2 - 144*z3)*pow4(Mt) + 3*(-75 + 32*z2 + 8*z3)*pow4(Mst2)*pow4(s2t)
        ) + 108*(-3 + z2)*pow2(-4*pow2(Mt) + pow2(Mst2)*pow2(s2t))*pow5(Mst2) -
        6*s2t*(Mst2*s2t*(1931 - 1098*z2 - 180*z3)*pow2(Mt) - 72*Mt*(-20 + 11*
        z2)*pow2(Mst2)*pow2(s2t) + 72*(-465 + 348*z2 - 176*z3)*pow3(Mt) + (38 +
        63*z2 - 90*z3)*pow3(Mst2)*pow3(s2t))*pow6(Mst1)) + pow2(Mgl)*(3087*
        pow2(Mst2)*pow4(Mst1)*(-8*pow2(Mst2)*pow2(Mt)*pow2(s2t)*(36449 + 4000*
        OepS2 - 310500*S2 - 6000*T1ep - 75750*z2 + 21000*z3 - 3000*z4 - 4500*
        pow2(z2)) - 864000*Mst2*s2t*(-6 + 5*z2 - 4*z3)*pow3(Mt) - 432000*Mt*(1
        + z2 - z3)*pow3(Mst2)*pow3(s2t) + 96*(-91321 + 54000*z2 - 36000*z3)*
        pow4(Mt) + (52199 + 28000*OepS2 - 3415500*S2 - 42000*T1ep - 557250*z2 +
        259500*z3 - 21000*z4 - 31500*pow2(z2))*pow4(Mst2)*pow4(s2t)) + 1157625*
        pow2(Mst1)*pow4(Mst2)*(-4*pow2(Mst2)*pow2(Mt)*pow2(s2t)*(32*OepS2 - 3*(
        391 + 972*S2 + 16*T1ep + 154*z2 - 232*z3 + 8*z4 + 12*pow2(z2))) - 1152*
        Mst2*s2t*(7 + 2*z2 - 8*z3)*pow3(Mt) - 1152*Mt*(-1 + 2*z2 - 3*z3)*pow3(
        Mst2)*pow3(s2t) + 64*(-103 + 108*z2 - 72*z3)*pow4(Mt) + (-1213 + 32*
        OepS2 + 4860*S2 - 48*T1ep - 462*z2 - 276*z3 - 24*z4 - 36*pow2(z2))*
        pow4(Mst2)*pow4(s2t)) + 2*(-4*pow2(Mst2)*pow2(Mt)*pow2(s2t)*(-22430251
        + 5488000*OepS2 - 324135000*S2 - 8232000*T1ep - 103929000*z2 +
        28812000*z3 - 4116000*z4 - 6174000*pow2(z2)) - 333396000*Mst2*s2t*(-35
        + 20*z2 - 16*z3)*pow3(Mt) + 333396000*Mt*(-2 + z2)*pow3(Mst2)*pow3(s2t)
        + 3456*(-6582784 + 2701125*z2 - 2315250*z3)*pow4(Mt) + (378483467 +
        9604000*OepS2 - 754771500*S2 - 14406000*T1ep - 306899250*z2 +
        133770000*z3 - 7203000*z4 - 10804500*pow2(z2))*pow4(Mst2)*pow4(s2t))*
        pow6(Mst1) + 41674500*(1 + 2*z2)*pow2(-4*pow2(Mt) + pow2(Mst2)*pow2(
        s2t))*pow6(Mst2))))/(pow2(Mgl)*pow2(Mst1)) + (pow2(Mst2)*(4*Dmglst2*
        Mgl*pow2(Mst1)*(-1764*pow2(Mst2)*pow4(Mst1)*(-112*pow2(Mst2)*pow2(Mt)*
        ...
        pow2(-4*pow2(Mt) + pow2(Mst2)*pow2(s2t))*pow8(Mst2))))/(pow2(Mgl)*pow4(
        Mst1))))/(6.001128e9*pow6(Mst2)))/pow4(Mt)/pow2(Sbeta)*12.;
 ...
 */
double himalaya::H6b2qg2::calc_coef_at_as2_no_sm_logs_log0(){

   const double result =
      ((pow2(Sbeta)*(-257250*z3*(23328*pow4(Mt)*(913.7777777777778 + (18034*
 ...
 */
double himalaya::H6b2qg2::calc_coef_at_as2_no_sm_logs_log1(){

   const double result =
      ((pow2(Sbeta)*(6000*pow2(Dmsqst2)*pow2(Mgl)*(72*(2*Mst2*s2t*(3 - 2*z2) +
        ...
        *pow8(Mst2))) + pow2(Mst2)*(-20*Dmglst2*Mgl*(-4*pow4(Mst1)*pow4(Mst2)*(
        ...
        16200.*pow2(Mgl)*pow4(Mst1)*pow6(Mst2)))/pow4(Mt)/pow2(Sbeta)*12.; 
 ...
 */
double himalaya::H6b2qg2::calc_coef_at_as2_no_sm_logs_log2(){

   const double result =
      ((pow2(Sbeta)*(-3600*pow2(Dmsqst2)*pow2(Mgl)*pow4(Mst1)*pow4(Mt) + 7200*
 ...
 */
double himalaya::H6b2qg2::calc_coef_at_as2_no_sm_logs_log3(){
