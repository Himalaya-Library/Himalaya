...
double himalaya::H32q2g::calc_coef_at_as2_no_sm_logs_log0() const {
   ...
   const double result =
      ((Mt*(-105840000*Mt*pow2(Mst1)*pow3(Dmsqst1)*pow6(Mst2) +
...
double himalaya::H32q2g::calc_coef_at_as2_no_sm_logs_log1() const {
   ...
   const double result =
      ((Mt*(2*Mst1*pow3(Dmglst1)*(-2*Mst1*Mt*pow2(Dmst12)*pow2(Mst2)
        ...
        *pow4(Mst2) - 14*Mt*pow6(Mst2)) + 150*Dmsqst1*Mt*pow2(Mst1)*(pow2(
        ...
        )))/(99225.*pow6(Mst1)*pow6(Mst2)))/pow4(Mt)*12.; 
...
double himalaya::H32q2g::calc_coef_at_as2_no_sm_logs_log2() const {
   ...
   const double result =
      ((-2*Mt*(7*Dmglst1*pow3(Mst1)*(2*Mt*pow2(Dmst12)*pow2(Mst2)*(-
