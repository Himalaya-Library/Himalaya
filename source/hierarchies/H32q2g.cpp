 ...
 */
double himalaya::H32q2g::calc_at_as2_no_logs(){

   const double result =
      (-(Mt*pow2(Sbeta)*(1470*Mt*pow2(Dmsqst1)*(-125*Dmst12*pow2(Mst1)*(Dmst12*
        pow2(Mst2)*(-32*(19*Dmglst1 + 52*Mst1)*Mt*s2t + 4*(566 - 567*z3)*pow2(
        Mt) + 3*(410 - 441*z3)*pow2(Mst1)*pow2(s2t)) + 2*pow2(Dmst12)*(16*(19*
        Dmglst1 + 52*Mst1)*Mt*s2t + 2*(-566 + 567*z3)*pow2(Mt) + 3*(-410 + 441*
        z3)*pow2(Mst1)*pow2(s2t)) + 4*Mt*(8*(19*Dmglst1 + 52*Mst1)*s2t + Mt*(-
        566 + 567*z3))*pow4(Mst2)) + 72000*Dmsqst1*pow2(Mst1)*pow6(Mst2) - 8*(-
        66000*Dmglst1*Mst1 + 1572*pow2(Dmglst1) + 125*(-598 + 567*z3)*pow2(
        Mst1))*pow2(Mt)*pow6(Mst2)) + 1470*Dmsqst1*Mst1*(128*pow2(Mt)*pow3(
        Dmglst1)*(1331*Dmst12*Mst1*s2t*(pow2(Dmst12) - Dmst12*pow2(Mst2) +
        ...
        201600*pow3(Mt)*pow6(Mst2))) + pow3(Mst1)*(8*pow3(Dmglst1)*(Mt*pow2(
        Dmst12)*pow2(Mst2)*(Mst1*Mt*s2t*(21284082326 - 17749864125*z3) + 40*(-
        16826654 + 15379875*z3)*pow2(Mt) + 7350*(520877 - 430155*z3)*pow2(Mst1)
        *pow2(s2t)) + pow3(Dmst12)*(2*Mst1*s2t*(-31902674758 + 26534253375*z3)*
        pow2(Mt) + 14700*Mt*(-520877 + 430155*z3)*pow2(Mst1)*pow2(s2t) + (
        673066160 - 615195000*z3)*pow3(Mt) + 245*(-14217821 + 11852775*z3)*
        pow3(Mst1)*pow3(s2t)) + 4*Dmst12*(Mt*(168266540 - 153798750*z3) + 49*
        Mst1*s2t*(108352984 - 89636625*z3))*pow2(Mt)*pow4(Mst2) + 392*(10583177
        - 8913375*z3)*pow3(Mt)*pow6(Mst2)) + 2*Mst1*pow2(Dmglst1)*(Mt*pow2(
        Dmst12)*pow2(Mst2)*(196*Mst1*Mt*s2t*(263717842 - 218365875*z3) + (-
        27129768542 + 22522586625*z3)*pow2(Mt) - 22050*(-63802 + 92895*z3)*
        pow2(Mst1)*pow2(s2t)) + pow3(Dmst12)*(392*Mst1*s2t*(-384557822 +
        319453875*z3)*pow2(Mt) - 66150*Mt*(-150737 + 112420*z3)*pow2(Mst1)*
        pow2(s2t) + (25287306692 - 22556819250*z3)*pow3(Mt) + 3675*(-1908362 +
        1581075*z3)*pow3(Mst1)*pow3(s2t)) + 392*Dmst12*(Mt*(73908751 -
        57368250*z3) + 20*Mst1*s2t*(6041999 - 5054400*z3))*pow2(Mt)*pow4(Mst2)
        + 3920*(8223692 - 6125625*z3)*pow3(Mt)*pow6(Mst2)) + 49*pow3(Mst1)*(-
        20*Mt*pow2(Dmst12)*pow2(Mst2)*(300*Mst1*Mt*s2t*(-17512 + 14805*z3) + (-
        375892 + 621675*z3)*pow2(Mt) + 900*(1226 - 495*z3)*pow2(Mst1)*pow2(s2t)
        ) + pow3(Dmst12)*(30*Mst1*s2t*(1117238 - 877575*z3)*pow2(Mt) + 2250*Mt*
        (5570 - 333*z3)*pow2(Mst1)*pow2(s2t) + (-41715182 + 38174625*z3)*pow3(
        Mt) + 3000*(-2722 + 2259*z3)*pow3(Mst1)*pow3(s2t)) + 6000*Dmst12*(8*
        Mst1*s2t*(694 - 477*z3) - 81*Mt*(-406 + 285*z3))*pow2(Mt)*pow4(Mst2) +
        48000*(623 + 963*z3)*pow3(Mt)*pow6(Mst2)) + 196*Dmglst1*pow2(Mst1)*(Mt*
        pow2(Dmst12)*pow2(Mst2)*(-40*Mst1*Mt*s2t*(-4511549 + 3729375*z3) + (-
        45149198 + 35285625*z3)*pow2(Mt) + 47250*(-430 + 207*z3)*pow2(Mst1)*
        pow2(s2t)) + pow3(Dmst12)*(2*Mst1*s2t*(28188929 - 23099625*z3)*pow2(Mt)
        - 225*Mt*(-160136 + 100785*z3)*pow2(Mst1)*pow2(s2t) + 6*(-19196074 +
        14320125*z3)*pow3(Mt) + 375*(-66522 + 56373*z3)*pow3(Mst1)*pow3(s2t)) -
        40*Dmst12*(150*Mst1*s2t*(-19856 + 17667*z3) + Mt*(-5136871 + 3912300*
        z3))*pow2(Mt)*pow4(Mst2) - 6000*(-31142 + 22653*z3)*pow3(Mt)*pow6(Mst2)
        ))))/(2.3814e7*pow6(Mst1)*pow6(Mst2)))/pow4(Mt)/pow2(Sbeta)*12.;
