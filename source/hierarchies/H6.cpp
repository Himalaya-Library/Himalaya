...
double himalaya::H6::calc_at_as2_no_logs(){

   const double result =
      ((pow2(Sbeta)*((-1029000*(3*Mst2*pow2(Dmglst2)*(3*pow2(Mst2)*(12*pow2(
        Mst2)*pow2(Mt)*pow2(s2t)*(336*T1ep + 55597*z3 - 264*z4 + 252*pow2(z2))
        + 32*Mst2*s2t*(224*T1ep - 19363*z3 + 112*z4 + 168*pow2(z2))*pow3(Mt) -
        16*Mt*(112*T1ep + 36013*z3 + 218*z4 - 3804*pow2(z2))*pow3(Mst2)*pow3(
        s2t) - 8*(2128*T1ep - 154541*z3 + 1064*z4 + 1596*pow2(z2))*pow4(Mt) + (
        56*T1ep - 129397*z3 - 6344*z4 - 1254*pow2(z2))*pow4(Mst2)*pow4(s2t)) +
        2*pow2(Mst1)*(18*pow2(Mst2)*pow2(Mt)*pow2(s2t)*(1584*T1ep - 15053*z3 +
        792*z4 + 1188*pow2(z2)) + 64*Mst2*s2t*(4228*T1ep - 32168*z3 + 2114*z4 +
        3171*pow2(z2))*pow3(Mt) - 4*Mt*(10948*T1ep - 88880*z3 + 5474*z4 + 8211*
        pow2(z2))*pow3(Mst2)*pow3(s2t) - 16*(22676*T1ep - 463990*z3 + 11338*z4
        + 17007*pow2(z2))*pow4(Mt) + (4544*T1ep - 99253*z3 + 4054*z4 + 5352*
        pow2(z2))*pow4(Mst2)*pow4(s2t))) + 3*Mst2*(18*pow4(Mst2)*(-6*pow2(Mst2)
        ...
        *pow4(Mt) + 3*(288*T1ep + 2239*z3 - 54*z4)*pow4(Mst2)*pow4(s2t)) - 27*
        ...
        pow2(z2))*pow4(Mst2)*pow4(s2t)))))/pow5(Mst2) + (pow4(s2t)*(-270*pow4(
        Mst1)*(128625*pow2(Dmglst2)*(3373*Mst2*pow2(Mst1) - 3287*pow3(Mst2)) +
        45671209*pow2(Mst1)*pow3(Mst2) - 18222471*Mst2*pow4(Mst1) - 257250*
        Dmglst2*(-793*pow2(Mst1)*pow2(Mst2) + 113*pow4(Mst1)))*pow5(Mst2) +
        5000940000*(pow2(Mst1) + pow2(Mst2))*pow2(-(Mst1*pow2(Mst2)) + pow3(
        Mst1))*pow6(Msq) - 5556600*pow2(Msq)*pow2(Mst1)*pow3(Mst2)*(5272*pow3(
        Mst2)*pow4(Mst1) - 5972*pow2(Mst1)*pow5(Mst2) + 100*pow2(Dmglst2)*(-
        272*pow2(Mst1)*pow3(Mst2) + 205*Mst2*pow4(Mst1) + 24*pow5(Mst2)) -
        2953*Mst2*pow6(Mst1) + 50*Dmglst2*(308*pow2(Mst2)*pow4(Mst1) - 460*
        pow2(Mst1)*pow4(Mst2) + 25*pow6(Mst1))) + Mst2*pow4(Msq)*(4116*Mst2*
        pow2(Dmglst2)*(-75*(-980039 + 41040*B4 - 43200*D3 + 22680*DN - 1120*
        OepS2 + 21325356*S2)*pow2(Mst2)*pow4(Mst1) - 23793750*pow2(Mst1)*pow4(
        Mst2) + 2*(-76330321 + 243000*B4 - 324000*D3 + 202500*DN + 2272000*
        OepS2 - 75724200*S2)*pow6(Mst1) + 2592000*pow6(Mst2)) + 3*Mst2*pow2(
        Mst1)*(20580*(-9250423 + 10800*B4 - 21600*D3 + 16200*DN + 274400*OepS2
        - 25409700*S2)*pow2(Mst2)*pow4(Mst1) - 3087000*(-9403 + 720*B4 - 72*D3
        + 36*DN - 384*OepS2 + 171072*S2)*pow2(Mst1)*pow4(Mst2) + (71378675209 +
        2000376000*B4 + 222264000*D3 - 222264000*DN + 5337080000*OepS2 -
        351825390000*S2)*pow6(Mst1) + 11252115000*pow6(Mst2)) - 4*Dmglst2*(
        2315250*(-7337 + 432*B4 - 576*D3 + 360*DN + 224*OepS2 + 543348*S2)*
        pow4(Mst1)*pow4(Mst2) - 12348*(1727459 + 81000*B4 - 108000*D3 + 67500*
        DN - 432000*OepS2 - 7425000*S2)*pow2(Mst2)*pow6(Mst1) + 4792567500*
        pow2(Mst1)*pow6(Mst2) + (-126628974763 + 11522056000*OepS2 -
        478191735000*S2)*pow8(Mst1)))))/(pow2(Mst2)*pow4(Msq)*pow4(Mst1)) + (
        68600*Mt*pow3(s2t)*(-6*Mst2*pow2(Dmglst2)*(2700*pow2(Mst1)*(-239*pow2(
        Mst1) + 1307*pow2(Mst2))*pow4(Mst2) + pow4(Msq)*(12*(186448 - 61560*B4
        + 1620*DN + 2240*OepS2 + 111213*S2)*pow2(Mst1)*pow2(Mst2) + (-9255817 +
        437920*OepS2 - 3648132*S2)*pow4(Mst1) + 311040*pow4(Mst2)) - 10800*
        pow2(Msq)*(35*pow2(Mst2)*pow4(Mst1) - 509*pow2(Mst1)*pow4(Mst2))) + 15*
        Mst2*(-270*(pow2(Mst1) - 223*pow2(Mst2))*pow4(Mst1)*pow4(Mst2) + pow4(
        Msq)*(6*(18641 + 7344*B4 + 216*DN - 2336*OepS2 + 112428*S2)*pow2(Mst2)*
        pow4(Mst1) + 27*(51531 + 5280*B4 - 48*DN - 224*OepS2 - 324*S2)*pow2(
        Mst1)*pow4(Mst2) + (542267 - 14048*OepS2 + 661068*S2)*pow6(Mst1) +
        41472*pow6(Mst2)) + 4320*pow2(Msq)*(50*pow4(Mst1)*pow4(Mst2) + 3*pow2(
        Mst2)*pow6(Mst1) - 71*pow2(Mst1)*pow6(Mst2))) + Dmglst2*(-194400*pow2(
        Msq)*pow2(Mst1)*pow2(Mst2)*(-36*pow2(Mst1)*pow2(Mst2) + pow4(Mst1) +
        95*pow4(Mst2)) + pow4(Msq)*(18*(-231989 + 36720*B4 + 1080*DN + 64160*
        OepS2 - 1515564*S2)*pow2(Mst2)*pow4(Mst1) + 27*(825997 + 188640*B4 -
        3600*DN + 5600*OepS2 + 146772*S2)*pow2(Mst1)*pow4(Mst2) + (-35542243 +
        2491360*OepS2 - 90290268*S2)*pow6(Mst1) - 622080*pow6(Mst2)) + 1350*(
        69*pow4(Mst2)*pow6(Mst1) + 2469*pow4(Mst1)*pow6(Mst2) - 5591*pow2(Mst1)
        *pow8(Mst2)))))/(pow2(Mst1)*pow2(Mst2)*pow4(Msq)) - (16*pow4(Mt)*(-4*
        Dmglst2*pow2(Mst1)*(pow4(Msq)*(882*(23048051 + 4508000*OepS2 -
        17853750*S2)*pow2(Mst2)*pow4(Mst1) + 132300*(496858 + 3920*OepS2 +
        129033*S2)*pow2(Mst1)*pow4(Mst2) + 5*(-72755578289 + 3063401600*OepS2 -
        52952863320*S2)*pow6(Mst1) - 10126903500*pow6(Mst2)) - 5788125*(1267*
        pow2(Mst1)*pow2(Mst2) - 498*pow4(Mst1) + 351*pow4(Mst2))*pow6(Mst2) -
        138915000*pow2(Msq)*(6*pow4(Mst1)*pow4(Mst2) + 261*pow2(Mst2)*pow6(
        Mst1) + 15*pow2(Mst1)*pow6(Mst2) + 56*pow8(Mst2))) - 3*Mst2*(
        1666980000*pow2(Mst1)*pow2(Mst2)*(pow2(Mst1) + pow2(Mst2))*pow6(Msq) +
        45*pow2(Mst1)*pow4(Mst2)*(2572500*pow2(Mst2)*pow4(Mst1) - 142320737*
        pow2(Mst1)*pow4(Mst2) + 47186763*pow6(Mst1) - 17235750*pow6(Mst2)) +
        pow4(Msq)*(154350*(326197 + 3360*OepS2 - 105948*S2)*pow4(Mst1)*pow4(
        Mst2) + 10290*(6906919 + 167200*OepS2 - 6744060*S2)*pow2(Mst2)*pow6(
        Mst1) + 7695891000*pow2(Mst1)*pow6(Mst2) + (175715865103 + 3204992000*
        OepS2 - 128216692800*S2)*pow8(Mst1) - 889056000*pow8(Mst2)) + 246960*
        pow2(Msq)*(22483*pow4(Mst2)*pow6(Mst1) - 23517*pow4(Mst1)*pow6(Mst2) +
        43875*pow2(Mst2)*pow8(Mst1) - 16125*pow2(Mst1)*pow8(Mst2))) + 294*Mst2*
        pow2(Dmglst2)*(2*pow4(Msq)*(15*(-126544097 + 744800*OepS2 + 29679210*
        S2)*pow2(Mst2)*pow4(Mst1) + 75836250*pow2(Mst1)*pow4(Mst2) + (-
        3444114731 + 158732000*OepS2 + 66753450*S2)*pow6(Mst1) - 18144000*pow6(
        Mst2)) + 75600*pow2(Msq)*(649*pow4(Mst1)*pow4(Mst2) + 525*pow2(Mst2)*
        pow6(Mst1) + 600*pow2(Mst1)*pow6(Mst2)) - 4725*(4750*pow4(Mst2)*pow6(
        Mst1) - 8971*pow4(Mst1)*pow6(Mst2) - 2025*pow2(Mst1)*pow8(Mst2)))))/(
        pow4(Msq)*pow4(Mst1)*pow5(Mst2)) - (39200*s2t*pow3(Mt)*(-24*Mst2*pow2(
        Dmglst2)*(pow4(Msq)*(3*(-4617197 + 15680*OepS2 + 953208*S2)*pow2(Mst1)*
        pow2(Mst2) + (-16684903 + 1183840*OepS2 + 5821092*S2)*pow4(Mst1) +
        544320*pow4(Mst2)) + 18900*pow2(Msq)*(21*pow2(Mst2)*pow4(Mst1) - 134*
        pow2(Mst1)*pow4(Mst2)) - 4725*(47*pow4(Mst1)*pow4(Mst2) + 673*pow2(
        Mst1)*pow6(Mst2))) + 21*Mst2*(pow4(Msq)*(3*(1058993 - 60320*OepS2 +
        1414908*S2)*pow2(Mst2)*pow4(Mst1) - 27*(-15759 + 1120*OepS2 + 25596*S2)
        *pow2(Mst1)*pow4(Mst2) + (7630228 - 438400*OepS2 + 14080608*S2)*pow6(
        Mst1) + 207360*pow6(Mst2)) + 3600*pow2(Msq)*(95*pow4(Mst1)*pow4(Mst2) +
        126*pow2(Mst2)*pow6(Mst1) + 238*pow2(Mst1)*pow6(Mst2)) + 900*(47*pow4(
        Mst2)*pow6(Mst1) + 10*pow4(Mst1)*pow6(Mst2) + 618*pow2(Mst1)*pow8(Mst2)
        )) + 7*Dmglst2*(pow4(Msq)*(27*(-678821 + 73760*OepS2 - 564876*S2)*pow2(
        Mst2)*pow4(Mst1) + 135*(-1983 + 1120*OepS2 + 43740*S2)*pow2(Mst1)*pow4(
        Mst2) + 4*(-24208447 + 2058400*OepS2 - 47545272*S2)*pow6(Mst1) -
        622080*pow6(Mst2)) - 10800*pow2(Msq)*(-131*pow4(Mst1)*pow4(Mst2) + 270*
        pow2(Mst2)*pow6(Mst1) - 750*pow2(Mst1)*pow6(Mst2)) + 2700*(155*pow4(
        Mst2)*pow6(Mst1) + 246*pow4(Mst1)*pow6(Mst2) + 2262*pow2(Mst1)*pow8(
        Mst2)))))/(pow2(Mst1)*pow4(Msq)*pow4(Mst2)) + (24*pow2(Mt)*pow2(s2t)*(
        12*Dmglst2*pow2(Mst1)*(pow4(Msq)*(1372*(2416741 + 300000*OepS2 -
        753300*S2)*pow2(Mst2)*pow4(Mst1) - 308700*(-28373 + 240*B4 - 240*D3 +
        120*DN + 34182*S2)*pow2(Mst1)*pow4(Mst2) + (-3966427397 + 2110136000*
        OepS2 - 52385772600*S2)*pow6(Mst1) + 828859500*pow6(Mst2)) + 15435000*
        pow2(Msq)*(45*pow4(Mst1)*pow4(Mst2) + 24*pow2(Mst2)*pow6(Mst1) - 107*
        pow2(Mst1)*pow6(Mst2) + 56*pow8(Mst2)) + 1929375*(9*pow4(Mst2)*pow6(
        Mst1) + 65*pow4(Mst1)*pow6(Mst2) - 203*pow2(Mst1)*pow8(Mst2))) + 882*
        Mst2*pow2(Dmglst2)*(2*pow4(Msq)*(-75*(-1903303 + 3360*B4 - 3360*D3 +
        1680*DN - 7840*OepS2 + 169452*S2)*pow2(Mst2)*pow4(Mst1) + 11450250*
        pow2(Mst1)*pow4(Mst2) + (24348041 + 2772000*OepS2 - 107403300*S2)*pow6(
        Mst1) - 2016000*pow6(Mst2)) + 315000*pow2(Msq)*(-33*pow4(Mst1)*pow4(
        Mst2) + 19*pow2(Mst2)*pow6(Mst1) + 16*pow2(Mst1)*pow6(Mst2)) - 39375*(
        33*pow4(Mst2)*pow6(Mst1) + 25*pow4(Mst1)*pow6(Mst2) - 27*pow2(Mst1)*
        pow8(Mst2))) + Mst2*(-1666980000*pow2(-(Mst1*pow2(Mst2)) + pow3(Mst1))*
        pow6(Msq) + pow4(Msq)*(77175*(818213 + 2880*D3 - 2880*DN - 11040*OepS2
        - 866052*S2)*pow4(Mst1)*pow4(Mst2) - 82320*(-517702 + 2700*D3 - 2700*DN
        + 64400*OepS2 - 1937115*S2)*pow2(Mst2)*pow6(Mst1) - 8584947000*pow2(
        Mst1)*pow6(Mst2) + (49148894324 - 9490124000*OepS2 + 376577264700*S2)*
        pow8(Mst1) + 889056000*pow8(Mst2)) + 246960*pow2(Msq)*(-3091*pow4(Mst2)
        *pow6(Mst1) - 22642*pow4(Mst1)*pow6(Mst2) + 5108*pow2(Mst2)*pow8(Mst1)
        + 16125*pow2(Mst1)*pow8(Mst2)) - 5400*(-130598*pow6(Mst1)*pow6(Mst2) +
        109502*pow4(Mst2)*pow8(Mst1) + 242073*pow4(Mst1)*pow8(Mst2)))))/(pow3(
        Mst2)*pow4(Msq)*pow4(Mst1)) + 14700*z2*((-12*pow2(Mt)*pow2(s2t)*(36*
        pow2(Dmglst2)*(63809*pow2(Mst1)*pow3(Mst2) + 801215*Mst2*pow4(Mst1) +
        21840*pow5(Mst2)) - 7*Mst2*(64800*pow2(Msq)*pow2(pow2(Mst1) - pow2(
        Mst2)) + 1774344*pow2(Mst2)*pow4(Mst1) - 161307*pow2(Mst1)*pow4(Mst2) +
        3321329*pow6(Mst1) - 105840*pow6(Mst2)) + 168*Dmglst2*(99000*pow2(Mst2)
        *pow4(Mst1) + 20994*pow2(Mst1)*pow4(Mst2) + 392665*pow6(Mst1) + 8280*
        pow6(Mst2))))/(pow2(Mst1)*pow3(Mst2)) + 408240*pow4(Mt)*(
        402.837037037037 + pow2(Dmglst2)*(80/(3.*pow2(Msq)) + 416/(9.*pow2(
        Mst1))) - (80*pow2(Msq))/(3.*pow2(Mst1)) + (8*pow2(Mst2)*(50/pow2(Msq)
        + 49/pow2(Mst1) + (90*pow2(Dmglst2))/pow4(Msq)))/9. + (40*(16*Dmglst2 +
        7*Mst2)*pow3(Mst2))/(9.*pow4(Msq)) + ((2722862*pow2(Dmglst2))/2835. - (
        80*pow2(Msq))/3. + (310039*pow2(Mst1))/405. + (80*pow4(Mst1))/(3.*pow2(
        Msq)))/pow2(Mst2) + (94481554*pow2(Dmglst2)*pow2(Mst1) + 8549366*pow4(
        Mst1))/(8505.*pow4(Mst2)) - (4*Dmglst2*(9*pow2(Mst1)*(2655197 + (37800*
        pow2(Mst1))/pow2(Msq))*pow2(Mst2) + 68105948*pow4(Mst1) + 3100707*pow4(
        Mst2) - 22680*(15/pow2(Msq) + 23/pow2(Mst1))*pow6(Mst2)))/(25515.*pow5(
        Mst2))) - (28*Mt*pow3(s2t)*(3*Mst2*(43200*pow2(Msq)*(pow2(Mst1) - 2*
        pow2(Mst2))*pow4(Mst2) + pow4(Msq)*(-237390*pow2(Mst1)*pow2(Mst2) -
        104839*pow4(Mst1) + 468315*pow4(Mst2)) + 16200*pow2(Mst1)*pow6(Mst2)) -
        6*pow2(Dmglst2)*(-64800*pow2(Msq)*(pow2(Mst1) - 9*pow2(Mst2))*pow3(
        Mst2) + (1467073*Mst2*pow2(Mst1) - 758244*pow3(Mst2))*pow4(Msq) -
        16200*(5*pow2(Mst1)*pow5(Mst2) - 23*pow7(Mst2))) + Dmglst2*(388800*
        pow2(Msq)*(pow2(Mst1) - 4*pow2(Mst2))*pow4(Mst2) + pow4(Msq)*(4207338*
        pow2(Mst1)*pow2(Mst2) + 8194483*pow4(Mst1) + 7515369*pow4(Mst2)) +
        16200*(15*pow2(Mst1)*pow6(Mst2) - 41*pow8(Mst2)))))/(pow2(Mst2)*pow4(
        Msq)) + (s2t*((-7*pow2(Mst2)*pow3(s2t)*(4050*pow2(Mst1)*pow3(Mst2)*(
        pow2(Mst2)*(-30*pow2(Dmglst2)*(7*Mst2*pow2(Mst1) - 6*pow3(Mst2)) - 14*
        pow2(Mst1)*pow3(Mst2) + 5*Mst2*pow4(Mst1) + 4*Dmglst2*(-21*pow2(Mst1)*
        pow2(Mst2) + 5*pow4(Mst1))) + 4*pow2(Msq)*(-10*pow2(Mst1)*pow3(Mst2) +
        pow2(Dmglst2)*(-60*Mst2*pow2(Mst1) + 57*pow3(Mst2)) + 3*Mst2*pow4(Mst1)
        + Dmglst2*(-40*pow2(Mst1)*pow2(Mst2) + 6*pow4(Mst1) + 34*pow4(Mst2)) +
        7*pow5(Mst2))) + 97200*(pow2(Mst1) - pow2(Mst2))*(pow4(Mst1) - pow4(
        Mst2))*pow6(Msq) + Mst2*pow4(Msq)*(3*Mst2*(1410594*pow2(Mst2)*pow4(
        Mst1) + 2*pow2(Dmglst2)*(81957*pow2(Mst1)*pow2(Mst2) + 418520*pow4(
        Mst1) - 28080*pow4(Mst2)) + 95220*pow2(Mst1)*pow4(Mst2) + 752185*pow6(
        Mst1) - 52920*pow6(Mst2)) - 4*Dmglst2*(420336*pow2(Mst2)*pow4(Mst1) +
        411345*pow2(Mst1)*pow4(Mst2) + 2200091*pow6(Mst1) + 74520*pow6(Mst2))))
        )/pow2(Mst1) + 16*pow3(Mt)*(24*pow2(Dmglst2)*((-6085792*Mst2*pow2(Mst1)
        + 38181*pow3(Mst2))*pow4(Msq) + 226800*pow2(Msq)*pow5(Mst2) + 340200*
        pow7(Mst2)) + 7*Dmglst2*(pow4(Msq)*(11830023*pow2(Mst1)*pow2(Mst2) +
        36911068*pow4(Mst1) + 821745*pow4(Mst2)) + 907200*pow2(Msq)*pow6(Mst2)
        + 712800*pow8(Mst2)) - 21*(pow4(Msq)*(1411971*pow2(Mst1)*pow3(Mst2) +
        2299036*Mst2*pow4(Mst1) + 780237*pow5(Mst2)) - 129600*pow2(Msq)*pow7(
        Mst2) - 64800*pow9(Mst2)))))/(pow4(Msq)*pow4(Mst2)))))/6.001128e9)/
   ...
   const double result =
      ((pow2(Sbeta)*(115200*pow11(Mst2)*pow2(Mt)*pow2(s2t)*pow4(Msq) - 2451200*
        ...
        *power10(Mst2) + 235800*Dmglst2*pow2(Mst1)*pow4(Msq)*pow4(s2t)*power10(
        Mst2)))/(16200.*pow4(Msq)*pow4(Mst1)*pow5(Mst2)))/pow4(Mt)/pow2(Sbeta)*
        12.; 
   ...
   const double result =
      ((pow2(Sbeta)*(1920*pow11(Mst2)*pow2(Mt)*pow2(s2t) + 52480*s2t*pow2(
        ...
        *pow2(s2t) + 912*Mst2*s2t*pow3(Mt) - 548*Mt*pow3(Mst2)*pow3(s2t) + 512*
        ...
        Mst1)*pow5(Mst2)))/pow4(Mt)/pow2(Sbeta)*12.; 
