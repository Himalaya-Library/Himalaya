 ...
 */
double himalaya::H6bq2g2::calc_at_as2_no_logs(){

   const double result =
      (pow2(Sbeta)*(pow4(Mt)*(480.98395061728394 + (3094132*Dmglst2)/(2835.*Mgl)
        + (13292051*pow2(Dmglst2))/(6075.*pow2(Mgl)) + (40*Dmsqst2*(2954*
        Dmglst2*(Dmglst2 + Mgl) - 309*pow2(Mgl)))/(81.*pow2(Mgl)*pow2(Msq)) - (
        5*pow2(Dmsqst2)*(5567 - (23632*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)))/(
        81.*pow4(Msq)) - (2*S2*(185409 - (258066*Dmglst2)/Mgl + (731241*pow2(
        Dmglst2))/pow2(Mgl) + (3*(79350*Dmglst2*Mgl + 128797*pow2(Dmglst2) +
        262269*pow2(Mgl))*pow2(Mst1))/(pow2(Mgl)*pow2(Mst2)) + (4*(363426 + (
        1000621*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow4(Mst1))/pow4(Mst2)))/
        2835. - (10*(4331 - (11816*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow3(
        Dmsqst2))/(81.*pow6(Msq)) + (pow2(Mst1)*(602.3877366255144 + (
        197768602*Dmglst2)/(212625.*Mgl) - (55610713*pow2(Dmglst2))/(637875.*
        pow2(Mgl)) - (4*Dmsqst2*(91321 - (902250*Dmglst2*(Dmglst2 + Mgl))/pow2(
        Mgl)))/(675.*pow2(Msq)) - (2*pow2(Dmsqst2)*(23941 - (120300*Dmglst2*(
        Dmglst2 + Mgl))/pow2(Mgl)))/(45.*pow4(Msq)) - (8*(133897 - (451125*
        Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow3(Dmsqst2))/(675.*pow6(Msq)) - (
        (2109.8103703703705 - (16040*Dmglst2*(Dmglst2 + Mgl))/(3.*pow2(Mgl)))*
        pow4(Dmsqst2))/pow8(Msq)))/pow2(Mst2) + (pow4(Mst1)*(562637865189 - (
        1098933505780*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl) - (341251522560*
        Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) +
        pow6(Msq)))/pow8(Msq)))/(3.750705e8*pow4(Mst2)) + ((-64*(-4*pow2(
        Dmglst2) + pow2(Mgl))*pow4(Mst2))/(9.*pow4(Mst1)) + (16*OepS2*(2*pow2(
        Dmglst2)*(-14109*pow2(Mst1)*pow2(Mst2) + 11164*pow4(Mst1) - 819*pow4(
        Mst2)) + 3*pow2(Mgl)*(627*pow2(Mst1)*pow2(Mst2) + 1168*pow4(Mst1) +
        189*pow4(Mst2)) + 4*Dmglst2*Mgl*(1449*pow2(Mst1)*pow2(Mst2) + 5582*
        pow4(Mst1) + 189*pow4(Mst2))))/(2187.*pow4(Mst2)) + (4*pow2(Mst2)*(
        pow2(Dmglst2)*(360*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)) - 788*pow8(Msq)) + 2*Dmglst2*Mgl*(180*
        Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) +
        pow6(Msq)) - 84*pow8(Msq)) - pow2(Mgl)*(30*pow2(Dmsqst2)*(5*pow2(
        Dmsqst2) + 3*Dmsqst2*pow2(Msq) + pow4(Msq)) - 30*Dmsqst2*pow6(Msq) -
        71*pow8(Msq))))/(9.*pow2(Mst1)*pow8(Msq)))/pow2(Mgl) - (5*(11757 - (
        23632*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow4(Dmsqst2))/(81.*pow8(Msq)
        )) - (T1ep*(2*Dmglst2*(2*Mgl*(pow4(Mst1)*(55368*pow2(Mst2)*pow2(Mt)*
        pow2(s2t) - 205840*Mst2*s2t*pow3(Mt) + 15571*Mt*pow3(Mst2)*pow3(s2t) +
        89312*pow4(Mt) - 4199*pow4(Mst2)*pow4(s2t)) + 18*pow2(Mst1)*pow2(Mst2)*
        (600*pow2(Mst2)*pow2(Mt)*pow2(s2t) - 2766*Mst2*s2t*pow3(Mt) + 401*Mt*
        pow3(Mst2)*pow3(s2t) + 1288*pow4(Mt) - 108*pow4(Mst2)*pow4(s2t)) - 189*
        pow4(Mst2)*(20*Mst2*s2t*pow3(Mt) - 5*Mt*pow3(Mst2)*pow3(s2t) - 16*pow4(
        Mt) + pow4(Mst2)*pow4(s2t))) + Dmglst2*(2*pow4(Mst1)*(55368*pow2(Mst2)*
        pow2(Mt)*pow2(s2t) - 205840*Mst2*s2t*pow3(Mt) + 15571*Mt*pow3(Mst2)*
        pow3(s2t) + 89312*pow4(Mt) - 4199*pow4(Mst2)*pow4(s2t)) - 63*pow4(Mst2)
        *(-72*pow2(Mst2)*pow2(Mt)*pow2(s2t) - 8*Mst2*s2t*pow3(Mt) + 2*Mt*pow3(
        Mst2)*pow3(s2t) + 208*pow4(Mt) + 5*pow4(Mst2)*pow4(s2t)) - 24*pow2(
        Mst1)*pow2(Mst2)*(-1791*pow2(Mst2)*pow2(Mt)*pow2(s2t) - 4307*Mst2*s2t*
        pow3(Mt) + 767*Mt*pow3(Mst2)*pow3(s2t) + 9406*pow4(Mt) + 20*pow4(Mst2)*
        pow4(s2t))))*pow8(Msq) + 3*pow2(Mgl)*(20*Dmsqst2*pow2(Mst2)*pow2(s2t)*(
        pow2(Mst1)*pow3(Dmsqst2)*(108*pow2(Mst2)*pow2(Mt) + 4*pow2(Mst1)*(37*
        pow2(Mt) - 7*pow2(Mst2)*pow2(s2t)) - 9*pow2(s2t)*pow4(Mst2)) + pow2(
        Dmsqst2)*pow2(Msq)*(2*(44*pow2(Mt) - 7*pow2(Mst2)*pow2(s2t))*pow4(Mst1)
        + 9*(-4*pow2(Mt) + pow2(Mst2)*pow2(s2t))*pow4(Mst2) + 3*pow2(Mst1)*(16*
        pow2(Mst2)*pow2(Mt) + 5*pow2(s2t)*pow4(Mst2))) + Dmsqst2*pow4(Msq)*(28*
        pow2(Mt)*pow4(Mst1) + 18*(-4*pow2(Mt) + pow2(Mst2)*pow2(s2t))*pow4(
        Mst2) + 3*pow2(Mst1)*(-4*pow2(Mst2)*pow2(Mt) + 13*pow2(s2t)*pow4(Mst2))
        ) + pow6(Msq)*((-32*pow2(Mt) + 14*pow2(Mst2)*pow2(s2t))*pow4(Mst1) + 9*
        pow2(Mst1)*(-8*pow2(Mst2)*pow2(Mt) + 7*pow2(s2t)*pow4(Mst2)) + 27*(-4*
        pow2(Mt)*pow4(Mst2) + pow2(s2t)*pow6(Mst2)))) + (54*pow4(Mst2)*(-106*
        pow2(Mst2)*pow2(Mt)*pow2(s2t) + 56*(Mt + Mst2*s2t)*pow3(Mt) - 14*Mt*
        pow3(Mst2)*pow3(s2t) + 23*pow4(Mst2)*pow4(s2t)) + 6*pow2(Mst1)*pow2(
        Mst2)*(-2516*pow2(Mst2)*pow2(Mt)*pow2(s2t) + 3016*Mst2*s2t*pow3(Mt) -
        292*Mt*pow3(Mst2)*pow3(s2t) + 1672*pow4(Mt) + 643*pow4(Mst2)*pow4(s2t))
        + pow4(Mst1)*(-27428*pow2(Mst2)*pow2(Mt)*pow2(s2t) + 43840*Mst2*s2t*
        pow3(Mt) - 1756*Mt*pow3(Mst2)*pow3(s2t) + 18688*pow4(Mt) + 1795*pow4(
        Mst2)*pow4(s2t)))*pow8(Msq))))/(1458.*pow2(Mgl)*pow4(Mst2)*pow8(Msq)) -
        (pow2(z2)*(pow4(s2t)*(-18*pow4(Mst2)*(9 + (474*Dmglst2)/Mgl + (683*
        pow2(Dmglst2))/pow2(Mgl) - (90*Dmsqst2)/pow2(Msq) - (60*pow2(Dmsqst2))/
        pow4(Msq) - (30*pow3(Dmsqst2))/pow6(Msq)) + pow4(Mst1)*(5385 - (16796*
        Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl) + (840*Dmsqst2)/pow2(Msq) - (840*
        pow3(Dmsqst2))/pow6(Msq) - (1680*pow4(Dmsqst2))/pow8(Msq)) + 6*pow2(
        Mst1)*pow2(Mst2)*(2577 + (1784*pow2(Dmglst2))/pow2(Mgl) + (630*Dmsqst2)
        /pow2(Msq) + (390*pow2(Dmsqst2))/pow4(Msq) + (150*pow3(Dmsqst2))/pow6(
        Msq) - (90*pow4(Dmsqst2))/pow8(Msq))) + (4*Mt*(4*pow3(Mt)*(2*pow2(
        Dmglst2)*(-14109*pow2(Mst1)*pow2(Mst2) + 11164*pow4(Mst1) - 819*pow4(
        Mst2)) + 3*pow2(Mgl)*(627*pow2(Mst1)*pow2(Mst2) + 1168*pow4(Mst1) +
        189*pow4(Mst2)) + 4*Dmglst2*Mgl*(1449*pow2(Mst1)*pow2(Mst2) + 5582*
        pow4(Mst1) + 189*pow4(Mst2))) - 4*Mst2*s2t*pow2(Mt)*(pow2(Dmglst2)*(-
        ...
        *pow6(Msq)) + (12*pow2(Dmglst2)*(597*pow2(Mst1)*pow2(Mst2) + 1538*pow4(
        ...
        pow2(Mgl)*pow4(Mst2))))/2916. + z2*(-(s2t*pow3(Mt)*((4*pow4(Mst1)*(
        1724277 + (-9908167*Dmglst2*(Dmglst2 + Mgl) - (48600*Dmsqst2*(87*
        Dmglst2*(Dmglst2 + Mgl) - 5*pow2(Mgl))*(pow2(Dmsqst2)*pow2(Msq) + pow3(
        Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)))/pow8(Msq))/pow2(Mgl)))/(
        3645.*pow3(Mst2)) + Mst2*(508.837037037037 - (4189*Dmglst2)/(9.*Mgl) +
        (2661049*pow2(Dmglst2))/(2835.*pow2(Mgl)) - (160*Dmsqst2*(19*Dmglst2*(
        Dmglst2 + Mgl) - pow2(Mgl)))/(3.*pow2(Mgl)*pow2(Msq)) + (80*pow2(
        Dmsqst2)*(7 - (38*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)))/(3.*pow4(Msq)) +
        (160*(6 - (19*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow3(Dmsqst2))/(3.*
        pow6(Msq)) + (80*(17 - (38*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow4(
        Dmsqst2))/(3.*pow8(Msq))) + (pow2(Mst1)*(1162.116049382716 - (510149*
        Dmglst2)/(135.*Mgl) + (47845349*pow2(Dmglst2))/(8505.*pow2(Mgl)) - (
        160*Dmsqst2*(51*Dmglst2*Mgl*(Dmsqst2 + pow2(Msq)) + 51*pow2(Dmglst2)*(
        Dmsqst2 + pow2(Msq)) - pow2(Mgl)*(12*Dmsqst2 + 5*pow2(Msq))))/(3.*pow2(
        Mgl)*pow4(Msq)) + (160*(19 - (51*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*
        pow3(Dmsqst2))/(3.*pow6(Msq)) - (160*(51*Dmglst2*(Dmglst2 + Mgl) - 26*
        pow2(Mgl))*pow4(Dmsqst2))/(3.*pow2(Mgl)*pow8(Msq))))/Mst2)) + pow4(Mt)*
        (362.837037037037 - (837364*Dmglst2)/(945.*Mgl) + (132382*pow2(Dmglst2)
        )/(81.*pow2(Mgl)) + (pow2(Mst1)*(765.5283950617284 - (12737588*Dmglst2)
        /(2835.*Mgl) + (21051518*pow2(Dmglst2))/(1701.*pow2(Mgl)) + (160*
        Dmsqst2*(6 - (77*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)))/(3.*pow2(Msq)) +
        (40*pow2(Dmsqst2)*(69 - (308*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)))/(3.*
        pow4(Msq)) + (80*(57 - (154*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow3(
        Dmsqst2))/(3.*pow6(Msq)) + (40*(159 - (308*Dmglst2*(Dmglst2 + Mgl))/
        pow2(Mgl))*pow4(Dmsqst2))/(3.*pow8(Msq))))/pow2(Mst2) + (2*pow4(Mst1)*(
        13164249 - (153221896*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl) + (4762800*
        Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) +
        pow6(Msq)))/pow8(Msq)))/(25515.*pow4(Mst2)) - (40*Dmsqst2*(92*Dmglst2*
        Mgl*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) +
        pow6(Msq)) + 92*pow2(Dmglst2)*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2)
        + Dmsqst2*pow4(Msq) + pow6(Msq)) - pow2(Mgl)*(38*pow2(Dmsqst2)*pow2(
        Msq) + 51*pow3(Dmsqst2) + 25*Dmsqst2*pow4(Msq) + 12*pow6(Msq))))/(3.*
        pow2(Mgl)*pow8(Msq)) - (8*pow2(Mst2)*(12*pow2(Dmglst2)*(5*Dmsqst2*(
        ...
        Mst1)*pow8(Msq))) + pow2(Mt)*pow2(s2t)*((pow4(Mst1)*(677.1664609053498
         - (157066*Dmglst2*(Dmglst2 + Mgl))/(
        81.*pow2(Mgl)) + (Dmsqst2*(16.625514403292183 - (610*Dmglst2*(Dmglst2 +
        Mgl))/(3.*pow2(Mgl))))/pow2(Msq) + (pow2(Dmsqst2)*(14.619341563786008 -
        (610*Dmglst2*(Dmglst2 + Mgl))/(3.*pow2(Mgl))))/pow4(Msq) + ((
        12.613168724279836 - (610*Dmglst2*(Dmglst2 + Mgl))/(3.*pow2(Mgl)))*
        pow3(Dmsqst2))/pow6(Msq) + ((10.606995884773662 - (610*Dmglst2*(Dmglst2
        + Mgl))/(3.*pow2(Mgl)))*pow4(Dmsqst2))/pow8(Msq)))/pow2(Mst2) + pow2(
        Mst2)*(10.975925925925926 - (19396*Dmglst2)/(135.*Mgl) - (123227*pow2(
        Dmglst2))/(315.*pow2(Mgl)) + (5*Dmsqst2*(576*Dmglst2*Mgl*(Dmsqst2 +
        pow2(Msq)) + 576*pow2(Dmglst2)*(Dmsqst2 + pow2(Msq)) + pow2(Mgl)*(58*
        Dmsqst2 + 231*pow2(Msq))))/(27.*pow2(Mgl)*pow4(Msq)) - ((
        21.296296296296298 - (320*Dmglst2*(Dmglst2 + Mgl))/(3.*pow2(Mgl)))*
        pow3(Dmsqst2))/pow6(Msq) - (160*(-2*Dmglst2*Mgl - 2*pow2(Dmglst2) +
        pow2(Mgl))*pow4(Dmsqst2))/(3.*pow2(Mgl)*pow8(Msq))) + (pow2(Mst1)*(-7*
        pow2(Mgl)*(41800*pow2(Msq)*pow3(Dmsqst2) + 77850*pow4(Dmsqst2) + 5750*
        pow2(Dmsqst2)*pow4(Msq) - 30300*Dmsqst2*pow6(Msq) - 309749*pow8(Msq)) +
        30*pow2(Dmglst2)*(20160*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(
        Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)) - 271543*pow8(Msq)) + 5040*
        Dmglst2*Mgl*(120*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)) - 505*pow8(Msq))))/(5670.*pow2(Mgl)*
        pow8(Msq)) + (4*pow4(Mst2)*(12*pow2(Dmglst2)*(5*Dmsqst2*(pow2(Dmsqst2)*
        pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)) - 2*pow8(
        Msq)) + 4*Dmglst2*Mgl*(15*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(
        Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)) + 7*pow8(Msq)) - pow2(Mgl)*(
        60*pow2(Msq)*pow3(Dmsqst2) + 75*pow4(Dmsqst2) + 45*pow2(Dmsqst2)*pow4(
        Msq) + 30*Dmsqst2*pow6(Msq) + 19*pow8(Msq))))/(9.*pow2(Mgl)*pow2(Mst1)*
        pow8(Msq))) - pow4(s2t)*((pow2(Mst1)*pow2(Mst2)*(1086897 - (426024*
        Dmglst2)/Mgl + (308396*pow2(Dmglst2))/pow2(Mgl) - (450*Dmsqst2*(576*
        Dmglst2*(Dmglst2 + Mgl) - 743*pow2(Mgl)))/(pow2(Mgl)*pow2(Msq)) + (
        9720*pow2(Dmsqst2)*(26.929012345679013 - (80*Dmglst2*(Dmglst2 + Mgl))/(
        3.*pow2(Mgl))))/pow4(Msq) + (150*(1261 - (1728*Dmglst2*(Dmglst2 + Mgl))
        /pow2(Mgl))*pow3(Dmsqst2))/pow6(Msq) + (450*(259 - (576*Dmglst2*(
        Dmglst2 + Mgl))/pow2(Mgl))*pow4(Dmsqst2))/pow8(Msq)))/9720. + (pow4(
        Mst2)*(6053 - (3934*Dmglst2)/Mgl - (80291*pow2(Dmglst2))/(15.*pow2(Mgl)
        ) + (30*Dmsqst2*(77 + (96*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)))/pow2(
        Msq) + (20*pow2(Dmsqst2)*(29 + (144*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))
        )/pow4(Msq) - (10*(115 - (288*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow3(
        Dmsqst2))/pow6(Msq) - (180*(16 - (16*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)
        )*pow4(Dmsqst2))/pow8(Msq)))/216. + pow4(Mst1)*(38.546039094650205 - (
        2272991*Dmglst2*(Dmglst2 + Mgl))/(14580.*pow2(Mgl)) + (Dmsqst2*(
        12.27366255144033 - (35*Dmglst2*(Dmglst2 + Mgl))/(3.*pow2(Mgl))))/pow2(
        Msq) + (5*pow2(Dmsqst2)*(17 - (28*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)))/
        (12.*pow4(Msq)) + (5*(92 - (567*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*
        pow3(Dmsqst2))/(243.*pow6(Msq)) - ((3.2973251028806585 + (35*Dmglst2*(
        Dmglst2 + Mgl))/(3.*pow2(Mgl)))*pow4(Dmsqst2))/pow8(Msq)) + (pow6(Mst2)
        *(12*pow2(Dmglst2)*(5*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2)
        + Dmsqst2*pow4(Msq) + pow6(Msq)) - 2*pow8(Msq)) + 4*Dmglst2*Mgl*(15*
        Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) +
        pow6(Msq)) + 7*pow8(Msq)) - pow2(Mgl)*(60*pow2(Msq)*pow3(Dmsqst2) + 75*
        pow4(Dmsqst2) + 45*pow2(Dmsqst2)*pow4(Msq) + 30*Dmsqst2*pow6(Msq) + 19*
        pow8(Msq))))/(18.*pow2(Mgl)*pow2(Mst1)*pow8(Msq))) + Mt*pow3(s2t)*((
        pow4(Mst1)*(21.57181069958848 - ((8583283*Dmglst2*(Dmglst2 + Mgl))/
        14580. + (40*Dmsqst2*(11*Dmglst2*Mgl + 11*pow2(Dmglst2) - pow2(Mgl)))/(
        3.*pow2(Msq)) + (5*pow2(Dmsqst2)*(88*Dmglst2*(Dmglst2 + Mgl) - 53*pow2(
        Mgl)))/(3.*pow4(Msq)) + (10*(44*Dmglst2*(Dmglst2 + Mgl) - 49*pow2(Mgl))
        *pow3(Dmsqst2))/(3.*pow6(Msq)) + (5*(88*Dmglst2*(Dmglst2 + Mgl) - 143*
        pow2(Mgl))*pow4(Dmsqst2))/(3.*pow8(Msq)))/pow2(Mgl)))/Mst2 + Mst2*pow2(
        Mst1)*(28.84567901234568 - (206741*Dmglst2)/(810.*Mgl) + (143005*pow2(
        Dmglst2))/(243.*pow2(Mgl)) - (80*Dmsqst2*(5*Dmglst2*(Dmglst2 + Mgl) +
        pow2(Mgl)))/(3.*pow2(Mgl)*pow2(Msq)) - (40*pow2(Dmsqst2)*(1 + (10*
        Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)))/(3.*pow4(Msq)) - (400*Dmglst2*(
        Dmglst2 + Mgl)*pow3(Dmsqst2))/(3.*pow2(Mgl)*pow6(Msq)) + (40*(1 - (10*
        Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow4(Dmsqst2))/(3.*pow8(Msq))) + (
        pow3(Mst2)*(pow2(Dmglst2)*(86400*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) +
        pow3(Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)) - 897737*pow8(Msq)) + 3*
        Dmglst2*Mgl*(28800*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)) - 173947*pow8(Msq)) - 45*pow2(Mgl)*(
        4800*pow2(Msq)*pow3(Dmsqst2) + 6240*pow4(Dmsqst2) + 3360*pow2(Dmsqst2)*
        pow4(Msq) + 1920*Dmsqst2*pow6(Msq) + 2269*pow8(Msq))))/(1620.*pow2(Mgl)
        *pow8(Msq)))) - s2t*pow3(Mt)*(S2*(-(Mst2*(94.8 - (270*Dmglst2)/Mgl + (
        18722*pow2(Dmglst2))/(105.*pow2(Mgl)))) + (2*(-329511*Dmglst2*Mgl -
        760703*pow2(Dmglst2) + 275121*pow2(Mgl))*pow2(Mst1))/(945.*Mst2*pow2(
        Mgl)) + (16*(48891 - (220117*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow4(
        Mst1))/(405.*pow3(Mst2))) + (2*pow4(Mst1)*(6050721 + (-20964397*
        Dmglst2*(Dmglst2 + Mgl) + (72900*Dmsqst2*(465*Dmglst2*(Dmglst2 + Mgl) -
        35*pow2(Mgl))*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(
        Msq) + pow6(Msq)))/pow8(Msq))/pow2(Mgl)))/(10935.*pow3(Mst2)) + (pow2(
        Mst1)*(24280053 - (20312523*Dmglst2)/Mgl - (79386499*pow2(Dmglst2))/
        pow2(Mgl) + (1360800*Dmsqst2*(2*pow2(Dmsqst2)*(56*Dmglst2*(Dmglst2 +
        Mgl) - 17*pow2(Mgl))*pow2(Msq) + (112*Dmglst2*(Dmglst2 + Mgl) - 45*
        pow2(Mgl))*pow3(Dmsqst2) + Dmsqst2*(112*Dmglst2*(Dmglst2 + Mgl) - 23*
        pow2(Mgl))*pow4(Msq) + 4*(28*Dmglst2*(Dmglst2 + Mgl) - 3*pow2(Mgl))*
        pow6(Msq)))/(pow2(Mgl)*pow8(Msq))))/(51030.*Mst2) + ((256*(-(Dmglst2*
        Mgl) - 4*pow2(Dmglst2) + pow2(Mgl))*pow3(Mst2))/(9.*pow2(Mst1)) + (16*
        OepS2*(pow2(Dmglst2)*(-12921*pow2(Mst1)*pow2(Mst2) + 51460*pow4(Mst1) -
        63*pow4(Mst2)) - 3*pow2(Mgl)*(1131*pow2(Mst1)*pow2(Mst2) + 2740*pow4(
        Mst1) + 189*pow4(Mst2)) + Dmglst2*Mgl*(12447*pow2(Mst1)*pow2(Mst2) +
        51460*pow4(Mst1) + 945*pow4(Mst2))))/(2187.*pow3(Mst2)) + (Mst2*(105*
        Dmglst2*Mgl*(138720*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)) - 30183*pow8(Msq)) - 567*pow2(Mgl)*(400*
        pow2(Msq)*pow3(Dmsqst2) + 3400*pow4(Dmsqst2) - 2600*pow2(Dmsqst2)*pow4(
        Msq) - 5600*Dmsqst2*pow6(Msq) - 6751*pow8(Msq)) + pow2(Dmglst2)*(
        14565600*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*
        pow4(Msq) + pow6(Msq)) + 6779161*pow8(Msq))))/(17010.*pow8(Msq)))/pow2(
        Mgl)) + Mt*pow3(s2t)*((S2*((6*(-42099*Dmglst2*Mgl - 8320*pow2(Dmglst2)
        + 15615*pow2(Mgl))*pow2(Mst1)*pow2(Mst2))/pow2(Mgl) + (91815 - (836021*
        Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow4(Mst1) - (27*(-1359*Dmglst2*Mgl
        + 1387*pow2(Dmglst2) + 45*pow2(Mgl))*pow4(Mst2))/pow2(Mgl)))/(810.*
        Mst2) + (pow4(Mst1)*(94.64797668038409 - (31897243*Dmglst2*(Dmglst2 +
        Mgl))/(87480.*pow2(Mgl)) + (20*Dmsqst2*(40*Dmglst2*(Dmglst2 + Mgl) - 4*
        pow2(Mgl)))/(3.*pow2(Mgl)*pow2(Msq)) - (pow2(Dmsqst2)*(505 - (1600*
        Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)))/(6.*pow4(Msq)) - (5*(85 - (160*
        Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow3(Dmsqst2))/(3.*pow6(Msq)) - (5*
        (239 - (320*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow4(Dmsqst2))/(6.*
        pow8(Msq))))/Mst2 + Mst2*pow2(Mst1)*(52.51131687242798 + (68*B4)/9. + (
        2*DN)/9. + (Dmglst2*(5.598971193415638 + (68*B4)/9. + (2*DN)/9.))/Mgl +
        ((192.65089163237312 + (68*B4)/9. + (2*DN)/9.)*pow2(Dmglst2))/pow2(Mgl)
        + (80*Dmsqst2*(12*Dmglst2*Mgl*(Dmsqst2 + pow2(Msq)) + 12*pow2(Dmglst2)*
        (Dmsqst2 + pow2(Msq)) - pow2(Mgl)*(2*Dmsqst2 + pow2(Msq))))/(3.*pow2(
        Mgl)*pow4(Msq)) - (80*(3 - (12*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*
        pow3(Dmsqst2))/(3.*pow6(Msq)) + (80*(12*Dmglst2*(Dmglst2 + Mgl) - 4*
        pow2(Mgl))*pow4(Dmsqst2))/(3.*pow2(Mgl)*pow8(Msq))) + ((4*OepS2*(pow2(
        Dmglst2)*(-9204*pow2(Mst1)*pow2(Mst2) + 15571*pow4(Mst1) - 63*pow4(
        Mst2)) - 3*pow2(Mgl)*(438*pow2(Mst1)*pow2(Mst2) + 439*pow4(Mst1) + 189*
        pow4(Mst2)) + Dmglst2*Mgl*(7218*pow2(Mst1)*pow2(Mst2) + 15571*pow4(
        Mst1) + 945*pow4(Mst2))))/(2187.*Mst2) + (64*(-(Dmglst2*Mgl) - 4*pow2(
        Dmglst2) + pow2(Mgl))*pow5(Mst2))/(9.*pow2(Mst1)) - (pow3(Mst2)*(3*
        Dmglst2*Mgl*(172800*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)) - (69997 + 188640*B4 - 3600*DN)*pow8(
        Msq)) - 135*pow2(Mgl)*(7680*pow2(Msq)*pow3(Dmsqst2) + 10560*pow4(
        Dmsqst2) + 4800*pow2(Dmsqst2)*pow4(Msq) + 1920*Dmsqst2*pow6(Msq) + (
        8537 + 1760*B4 - 16*DN)*pow8(Msq)) + pow2(Dmglst2)*(518400*Dmsqst2*(
        pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)
        ) + (2048393 - 1058400*B4 + 23760*DN)*pow8(Msq))))/(9720.*pow8(Msq)))/
        pow2(Mgl)) - pow2(Mt)*((40*(3*Dmsqst2 + pow2(Msq))*pow2(Mst2)*pow3(
        Dmsqst2))/(3.*pow8(Msq)) - pow2(s2t)*(S2*((pow4(Mst1)*(399127 - (
        678792*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl) + (14000*Dmsqst2)/pow2(Msq) -
        (6900*pow2(Dmsqst2))/pow4(Msq) - (27800*pow3(Dmsqst2))/pow6(Msq) - (
        48700*pow4(Dmsqst2))/pow8(Msq)))/(270.*pow2(Mst2)) + (pow2(Mst1)*(27573
        - (2232*Dmglst2)/Mgl - (254298*pow2(Dmglst2))/(7.*pow2(Mgl)) + (6900*
        Dmsqst2)/pow2(Msq) + (3350*pow2(Dmsqst2))/pow4(Msq) - (200*pow3(
        Dmsqst2))/pow6(Msq) - (3750*pow4(Dmsqst2))/pow8(Msq)))/45. - pow2(Mst2)
        *(42.3 + (2532*Dmglst2)/(5.*Mgl) + (20862*pow2(Dmglst2))/(35.*pow2(Mgl)
        ) - (270*Dmsqst2)/pow2(Msq) - (260*pow2(Dmsqst2))/pow4(Msq) - (250*
        pow3(Dmsqst2))/pow6(Msq) - (240*pow4(Dmsqst2))/pow8(Msq))) + (pow2(
        Mst2)*(1013263 + 2880*D3 - 2880*DN - (192*Dmglst2*(-5837 + 60*B4 - 60*
        D3 + 30*DN))/Mgl - (36*(-939499 + 3360*B4 - 3360*D3 + 1680*DN)*pow2(
        Dmglst2))/(7.*pow2(Mgl)) - (900*Dmsqst2*(368*Dmglst2*(Dmglst2 + Mgl) -
        391*pow2(Mgl)))/(pow2(Mgl)*pow2(Msq)) + (100*pow2(Dmsqst2)*(Dmsqst2*(
        3359 - (3312*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)) + (3439 - (3312*
        Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow2(Msq)))/pow6(Msq) + (300*(1093
        - (1104*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow4(Dmsqst2))/pow8(Msq)))/
        3240. + (pow4(Mst1)*(199.98139767323744 - (3650009897*Dmglst2*(Dmglst2
        + Mgl))/(2.083725e7*pow2(Mgl)) + (Dmsqst2*(3.5881655848700444 + (9655*
        Dmglst2*(Dmglst2 + Mgl))/(27.*pow2(Mgl))))/pow2(Msq) - (pow2(Dmsqst2)*(
        54.06530056349406 - (9655*Dmglst2*(Dmglst2 + Mgl))/(27.*pow2(Mgl))))/
        pow4(Msq) - ((111.71876671185817 - (9655*Dmglst2*(Dmglst2 + Mgl))/(27.*
        pow2(Mgl)))*pow3(Dmsqst2))/pow6(Msq) - ((169.37223286022228 - (9655*
        Dmglst2*(Dmglst2 + Mgl))/(27.*pow2(Mgl)))*pow4(Dmsqst2))/pow8(Msq)))/
        pow2(Mst2) + pow2(Mst1)*(97.4135390946502 - (8*D3)/9. + (8*DN)/9. + (
        4867232*Dmglst2)/(30375.*Mgl) + (273721621*pow2(Dmglst2))/(425250.*
        pow2(Mgl)) - (Dmsqst2*(17.999506172839506 + (2260*Dmglst2*(Dmglst2 +
        Mgl))/(9.*pow2(Mgl))))/pow2(Msq) + (2*pow2(Dmsqst2)*(1241 - (152550*
        Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl)))/(1215.*pow4(Msq)) + ((
        22.085102880658436 - (2260*Dmglst2*(Dmglst2 + Mgl))/(9.*pow2(Mgl)))*
        pow3(Dmsqst2))/pow6(Msq) + ((42.12740740740741 - (2260*Dmglst2*(Dmglst2
        + Mgl))/(9.*pow2(Mgl)))*pow4(Dmsqst2))/pow8(Msq)) + ((32*(-4*pow2(
        Dmglst2) + pow2(Mgl))*pow6(Mst2))/(9.*pow4(Mst1)) - (2*pow4(Mst2)*(
        pow2(Dmglst2)*(360*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)) - 820*pow8(Msq)) - pow2(Mgl)*(30*pow2(
        Dmsqst2)*(5*pow2(Dmsqst2) + 3*Dmsqst2*pow2(Msq) + pow4(Msq)) - 30*
        Dmsqst2*pow6(Msq) - 87*pow8(Msq)) + 2*Dmglst2*Mgl*(180*Dmsqst2*(pow2(
        Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)) -
        52*pow8(Msq))))/(9.*pow2(Mst1)*pow8(Msq)) + (4*OepS2*(20*Dmsqst2*pow2(
        Mgl)*(pow3(Dmsqst2)*(27*pow2(Mst1)*pow2(Mst2) + 37*pow4(Mst1)) +
        Dmsqst2*pow4(Msq)*(-3*pow2(Mst1)*pow2(Mst2) + 7*pow4(Mst1) - 18*pow4(
        Mst2)) + pow2(Dmsqst2)*pow2(Msq)*(12*pow2(Mst1)*pow2(Mst2) + 22*pow4(
        Mst1) - 9*pow4(Mst2)) - (18*pow2(Mst1)*pow2(Mst2) + 8*pow4(Mst1) + 27*
        pow4(Mst2))*pow6(Msq)) + (24*Dmglst2*Mgl*pow2(Mst1)*(769*pow2(Mst1) +
        150*pow2(Mst2)) + 12*pow2(Dmglst2)*(597*pow2(Mst1)*pow2(Mst2) + 1538*
        pow4(Mst1) + 63*pow4(Mst2)) - pow2(Mgl)*(3774*pow2(Mst1)*pow2(Mst2) +
        6857*pow4(Mst1) + 1431*pow4(Mst2)))*pow8(Msq)))/(729.*pow2(Mst2)*pow8(
        Msq)))/pow2(Mgl))) - (z3*(16*pow4(Mt)*(1332288 + (973836*Dmglst2)/Mgl +
        (4688694*pow2(Dmglst2))/pow2(Mgl) - (1215*Dmsqst2*(640*Dmglst2*Mgl*(
        Dmsqst2 + pow2(Msq)) + 640*pow2(Dmglst2)*(Dmsqst2 + pow2(Msq)) - pow2(
        Mgl)*(203*Dmsqst2 + 128*pow2(Msq))))/(pow2(Mgl)*pow4(Msq)) + (2430*(139
        - (320*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow3(Dmsqst2))/pow6(Msq) + (
        6*pow2(Mst1)*(414300 - (692304*Dmglst2)/Mgl + (1785736*pow2(Dmglst2))/
        pow2(Mgl) - (12960*Dmsqst2*(36*Dmglst2*Mgl*(pow2(Dmsqst2) + Dmsqst2*
        pow2(Msq) + pow4(Msq)) + 36*pow2(Dmglst2)*(pow2(Dmsqst2) + Dmsqst2*
        pow2(Msq) + pow4(Msq)) - pow2(Mgl)*(14*pow2(Dmsqst2) + 9*Dmsqst2*pow2(
        Msq) + 4*pow4(Msq))))/(pow2(Mgl)*pow6(Msq)) + (243*(1013.3333333333334
         - (1920*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl))*pow4(Dmsqst2))/pow8(Msq)))
        /pow2(Mst2) + (64*pow4(Mst1)*(72723 - (295693*Dmglst2*(Dmglst2 + Mgl))/
        pow2(Mgl) + (7290*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)))/pow8(Msq)))/pow4(Mst2) - (1215*(640*
        Dmglst2*(Dmglst2 + Mgl) - 353*pow2(Mgl))*pow4(Dmsqst2))/(pow2(Mgl)*
        pow8(Msq))) + (pow2(s2t)*((32*Mt*s2t*(2430*(pow4(Dmsqst2)*(8*Dmglst2*(
        Dmglst2 + Mgl)*pow2(Mst2)*(3*pow2(Mst1) + pow2(Mst2)) + pow2(Mgl)*(-20*
        pow2(Mst1)*pow2(Mst2) + 45*pow4(Mst1) - 36*pow4(Mst2))) + pow2(Dmsqst2)
        *pow4(Msq)*(8*Dmglst2*(Dmglst2 + Mgl)*pow2(Mst2)*(3*pow2(Mst1) + pow2(
        Mst2)) + pow2(Mgl)*(-12*pow2(Mst1)*pow2(Mst2) + 15*pow4(Mst1) - 28*
        pow4(Mst2)))) + 4860*pow2(Msq)*pow3(Dmsqst2)*(4*Dmglst2*(Dmglst2 + Mgl)
        *pow2(Mst2)*(3*pow2(Mst1) + pow2(Mst2)) + pow2(Mgl)*(-8*pow2(Mst1)*
        pow2(Mst2) + 15*pow4(Mst1) - 16*pow4(Mst2))) + 19440*Dmsqst2*pow2(Mst2)
        *(Dmglst2*(Dmglst2 + Mgl)*(3*pow2(Mst1) + pow2(Mst2)) - pow2(Mgl)*(
        pow2(Mst1) + 3*pow2(Mst2)))*pow6(Msq) + (pow2(Dmglst2)*(171510*pow2(
        Mst1)*pow2(Mst2) - 282607*pow4(Mst1) - 998613*pow4(Mst2)) + 3*pow2(Mgl)
        *(19554*pow2(Mst1)*pow2(Mst2) + 22315*pow4(Mst1) - 53685*pow4(Mst2)) -
        Dmglst2*Mgl*(36810*pow2(Mst1)*pow2(Mst2) + 282607*pow4(Mst1) + 408699*
        pow4(Mst2)))*pow8(Msq)))/Mst2 + (24*pow2(Mt)*(6*pow2(Dmglst2)*(5400*
        Dmsqst2*pow4(Mst1)*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*
        pow4(Msq) + pow6(Msq)) - (27375*pow2(Mst1)*pow2(Mst2) + 5872*pow4(Mst1)
        - 177327*pow4(Mst2))*pow8(Msq)) - pow2(Mgl)*(5*pow2(Dmsqst2)*pow4(Msq)*
        ...
        Dmglst2*Mgl*(675*Dmsqst2*pow4(Mst1)*(pow2(Dmsqst2)*pow2(Msq) + pow3(
        Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)) - (-2223*pow2(Mst1)*pow2(
        Mst2) + 734*pow4(Mst1) - 1317*pow4(Mst2))*pow8(Msq))))/pow2(Mst2) +
        pow2(s2t)*(4*pow2(Dmglst2)*(19440*Dmsqst2*(-2*pow2(Mst1)*pow2(Mst2) +
        5*pow4(Mst1) - 3*pow4(Mst2))*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)) + (-740130*pow2(Mst1)*pow2(Mst2) +
        434566*pow4(Mst1) - 2057463*pow4(Mst2))*pow8(Msq)) + 8*Dmglst2*Mgl*(
        9720*Dmsqst2*(-2*pow2(Mst1)*pow2(Mst2) + 5*pow4(Mst1) - 3*pow4(Mst2))*(
        pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)
        ) + (-101466*pow2(Mst1)*pow2(Mst2) + 217283*pow4(Mst1) - 475605*pow4(
        Mst2))*pow8(Msq)) - 3*pow2(Mgl)*(5*pow4(Dmsqst2)*(-9198*pow2(Mst1)*
        pow2(Mst2) + 15679*pow4(Mst1) - 128817*pow4(Mst2)) + 10*pow2(Msq)*pow3(
        Dmsqst2)*(1086*pow2(Mst1)*pow2(Mst2) + 6613*pow4(Mst1) - 44595*pow4(
        Mst2)) + 15*pow2(Dmsqst2)*pow4(Msq)*(4514*pow2(Mst1)*pow2(Mst2) + 3591*
        pow4(Mst1) - 16521*pow4(Mst2)) + 80*Dmsqst2*(1557*pow2(Mst1)*pow2(Mst2)
        + 520*pow4(Mst1) - 621*pow4(Mst2))*pow6(Msq) + 16*(35931*pow2(Mst1)*
        pow2(Mst2) + 5225*pow4(Mst1) + 35613*pow4(Mst2))*pow8(Msq)))))/(pow2(
        Mgl)*pow8(Msq)) - (128*s2t*pow3(Mt)*(4*pow4(Mst1)*(86637 + (-326791*
        Dmglst2*(Dmglst2 + Mgl) + (9720*Dmsqst2*(-11*Dmglst2*Mgl - 11*pow2(
        Dmglst2) + pow2(Mgl))*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)))/pow8(Msq))/pow2(Mgl)) + (-9*pow4(Mst2)*
        (8*pow2(Dmglst2)*(1620*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2)
        + Dmsqst2*pow4(Msq) + pow6(Msq)) - 4037*pow8(Msq)) + 27*Dmglst2*Mgl*(
        480*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(
        Msq) + pow6(Msq)) + pow8(Msq)) - 9*pow2(Mgl)*(960*pow2(Msq)*pow3(
        Dmsqst2) + 1200*pow4(Dmsqst2) + 720*pow2(Dmsqst2)*pow4(Msq) + 480*
        Dmsqst2*pow6(Msq) + 961*pow8(Msq))) - 3*pow2(Mst1)*pow2(Mst2)*(pow2(
        Dmglst2)*(90720*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        ...
        pow3(Mst2)))/23328. + pow4(s2t)*(-(pow2(Mst1)*pow2(Mst2)*(
        79.01365226337448 - B4/9. + (2*D3)/9. - DN/6. + (Dmglst2*(
        0.7822304526748971 - (2*B4)/3. + (8*D3)/9. - (5*DN)/9.))/Mgl + ((
        30.209968449931413 - B4 + (4*D3)/3. - (5*DN)/6.)*pow2(Dmglst2))/pow2(
        Mgl) - (Dmsqst2*(3.2221604938271606 - (125*Dmglst2*(Dmglst2 + Mgl))/(2.
        *pow2(Mgl))))/pow2(Msq) - (pow2(Dmsqst2)*(23.10627572016461 - (125*
        Dmglst2*(Dmglst2 + Mgl))/(2.*pow2(Mgl))))/pow4(Msq) - ((
        42.99039094650206 - (125*Dmglst2*(Dmglst2 + Mgl))/(2.*pow2(Mgl)))*pow3(
        Dmsqst2))/pow6(Msq) - ((62.8745061728395 - (125*Dmglst2*(Dmglst2 + Mgl)
        )/(2.*pow2(Mgl)))*pow4(Dmsqst2))/pow8(Msq))) + pow4(Mst1)*(
        46.745471895783595 + B4 + D3/9. - DN/9. + (119405394763*Dmglst2*(
        Dmglst2 + Mgl))/(1.500282e9*pow2(Mgl)) + (Dmsqst2*(15.13649301931237 +
        (190*Dmglst2*(Dmglst2 + Mgl))/(27.*pow2(Mgl))))/pow2(Msq) + (pow2(
        Dmsqst2)*(13.217310375649378 + (190*Dmglst2*(Dmglst2 + Mgl))/(27.*pow2(
        Mgl))))/pow4(Msq) + ((11.298127731986387 + (190*Dmglst2*(Dmglst2 + Mgl)
        )/(27.*pow2(Mgl)))*pow3(Dmsqst2))/pow6(Msq) + ((9.378945088323395 + (
        190*Dmglst2*(Dmglst2 + Mgl))/(27.*pow2(Mgl)))*pow4(Dmsqst2))/pow8(Msq))
        - S2*((5*pow4(Mst1)*(5055 - (10327*Dmglst2*(Dmglst2 + Mgl))/pow2(Mgl) +
        (978*Dmsqst2)/pow2(Msq) + (300*pow2(Dmsqst2))/pow4(Msq) - (378*pow3(
        Dmsqst2))/pow6(Msq) - (1056*pow4(Dmsqst2))/pow8(Msq)))/162. + pow4(
        Mst2)*((1677*Dmglst2)/(2.*Mgl) + (116129*pow2(Dmglst2))/(60.*pow2(Mgl))
        - (1310*pow2(Msq)*pow3(Dmsqst2) + 1740*pow4(Dmsqst2) + 880*pow2(
        Dmsqst2)*pow4(Msq) + 450*Dmsqst2*pow6(Msq) - 921*pow8(Msq))/(4.*pow8(
        Msq))) + (pow2(Mst1)*pow2(Mst2)*((33000*Dmglst2)/Mgl + (89092*pow2(
        Dmglst2))/pow2(Mgl) + (15*(5150*pow2(Msq)*pow3(Dmsqst2) + 3930*pow4(
        Dmsqst2) + 6370*pow2(Dmsqst2)*pow4(Msq) + 7590*Dmsqst2*pow6(Msq) +
        17151*pow8(Msq)))/pow8(Msq)))/540.) + ((OepS2*(60*Dmsqst2*pow2(Mgl)*(3*
        Dmsqst2*pow2(Mst2)*(13*pow2(Mst1) + 6*pow2(Mst2))*pow4(Msq) - pow3(
        Dmsqst2)*(9*pow2(Mst1)*pow2(Mst2) + 28*pow4(Mst1)) + pow2(Dmsqst2)*
        pow2(Msq)*(15*pow2(Mst1)*pow2(Mst2) - 14*pow4(Mst1) + 9*pow4(Mst2)) + (
        63*pow2(Mst1)*pow2(Mst2) + 14*pow4(Mst1) + 27*pow4(Mst2))*pow6(Msq)) -
        (4*Dmglst2*Mgl*(1944*pow2(Mst1)*pow2(Mst2) + 4199*pow4(Mst1) + 189*
        pow4(Mst2)) + 2*pow2(Dmglst2)*(480*pow2(Mst1)*pow2(Mst2) + 8398*pow4(
        Mst1) + 315*pow4(Mst2)) - 3*pow2(Mgl)*(3858*pow2(Mst1)*pow2(Mst2) +
        1795*pow4(Mst1) + 1242*pow4(Mst2)))*pow8(Msq)))/(2187.*pow8(Msq)) + (
        pow4(Mst2)*((540*pow2(Mst2)*(pow2(Dmglst2)*(360*Dmsqst2*(pow2(Dmsqst2)*
        pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)) - 980*pow8(
        Msq)) + 2*Dmglst2*Mgl*(180*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(
        Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)) - 20*pow8(Msq)) - 15*pow2(
        Mgl)*(6*pow2(Msq)*pow3(Dmsqst2) + 10*pow4(Dmsqst2) + 2*pow2(Dmsqst2)*
        pow4(Msq) - 2*Dmsqst2*pow6(Msq) - 9*pow8(Msq))))/pow2(Mst1) + pow2(
        Dmglst2)*(129600*Dmsqst2*(pow2(Dmsqst2)*pow2(Msq) + pow3(Dmsqst2) +
        Dmsqst2*pow4(Msq) + pow6(Msq)) + (1395899 - 54000*B4 + 60480*D3 -
        33480*DN)*pow8(Msq)) + 30*Dmglst2*Mgl*(4320*Dmsqst2*(pow2(Dmsqst2)*
        pow2(Msq) + pow3(Dmsqst2) + Dmsqst2*pow4(Msq) + pow6(Msq)) + (15707 -
        432*B4 + 576*D3 - 360*DN)*pow8(Msq)) - 15*pow2(Mgl)*(47000*pow2(Msq)*
        pow3(Dmsqst2) + 52305*pow4(Dmsqst2) + 41695*pow2(Dmsqst2)*pow4(Msq) +
        36390*Dmsqst2*pow6(Msq) + (25289 + 1440*B4 - 144*D3 + 72*DN)*pow8(Msq))
        ))/(19440.*pow8(Msq)) + (16*pow2(Dmglst2)*pow8(Mst2))/(9.*pow4(Mst1)))/
        pow2(Mgl))))/pow4(Mt)/pow2(Sbeta)*12.;
   ...
   const double result =
      ((pow2(Sbeta)*(30*log(pow2(Mst2)/pow2(Mst1))*pow4(Mst1)*(pow2(Mgl)*(-4*
        ...
        *pow6(Mst1) - 3*pow2(Mst1)*(-856*pow2(Mst2)*pow2(Mt)*pow2(s2t) - 1024*
        ...
        Mst1)*pow4(Mst2)*pow8(Msq)))/pow4(Mt)/pow2(Sbeta)*12.; 
