...
TestPoint[point_, name_] :=
    Module[{output, eps},
           ...
           TestClose[Mh2FOAtAsAndAtAt                               /. output, Mh2FOAtAsAndAtAt                               /. (expectedOutput /. point), eps];
...
MakePoint[MS_?NumericQ, TB_?NumericQ, Xt_?NumericQ] := {
    ...
    expectedOutput -> {
        ...
        Mh2FO -> {8229.896089958725, 8148.2372899382335, 819.1872548102838, 0},
        Mh2FOAtAsAndAtAt -> {8229.896089958725, 8148.2372899382335, 820.6212844284601, 0},
