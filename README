...
```
to your file. In the next step you have to initialize all needed parameters in the `Parameters` `struct`. Here, an example for a SPS2 benchmark point is given:
```cpp
